...
GetProductosProv getProductosProvFromMap(String str) =>
    GetProductosProv.fromMap(json.decode(str));

String getProductosProvToMap(GetProductosProv data) =>
...
class GetProductosProv {
  ...
  factory GetProductosProv.fromMap(Map<String, dynamic> json) =>
      GetProductosProv(
        ...
        costoProdProv: json["costo_prod_prov"] == null
            ? null
