...
GetBasicProductosCotizadosPocketbase
    getBasicProductosCotizadosPocketbaseFromMap(String str) =>
        GetBasicProductosCotizadosPocketbase.fromMap(json.decode(str));

String getBasicProductosCotizadosPocketbaseToMap(
        GetBasicProductosCotizadosPocketbase data) =>
...
class GetBasicProductosCotizadosPocketbase {
  ...
  factory GetBasicProductosCotizadosPocketbase.fromMap(
          Map<String, dynamic> json) =>
      GetBasicProductosCotizadosPocketbase(
        page: json["page"],
        perPage: json["perPage"],
        totalItems: json["totalItems"],
        items: List<ProductoCotizado>.from(
            json["items"].map((x) => ProductoCotizado.fromMap(x))),
      );
...
class ProductoCotizado {
  ...
  factory ProductoCotizado.fromMap(Map<String, dynamic> json) =>
      ProductoCotizado(
...
class ProductoCotizadoExpand {
  ...
  factory ProductoCotizadoExpand.fromMap(Map<String, dynamic> json) =>
      ProductoCotizadoExpand(
...
class IdProductoProvFk {
  ...
  factory IdProductoProvFk.fromMap(Map<String, dynamic> json) =>
      IdProductoProvFk(
        collectionId: json["@collectionId"],
        collectionName: json["@collectionName"],
