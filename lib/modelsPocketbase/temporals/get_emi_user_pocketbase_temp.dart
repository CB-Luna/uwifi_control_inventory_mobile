...
GetEmiUserPocketbasetemp getEmiUserPocketbasetempFromMap(String str) => GetEmiUserPocketbasetemp.fromMap(json.decode(str));

String getEmiUserPocketbasetempToMap(GetEmiUserPocketbasetemp data) => json.encode(data.toMap());

class GetEmiUserPocketbasetemp {
    GetEmiUserPocketbasetemp({
    ...
    factory GetEmiUserPocketbasetemp.fromMap(Map<String, dynamic> json) => GetEmiUserPocketbasetemp(
