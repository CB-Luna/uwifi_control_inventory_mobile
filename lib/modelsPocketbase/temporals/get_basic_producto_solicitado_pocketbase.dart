...
GetBasicProductoSolicitadoPocketbase getBasicProductoSolicitadoPocketbaseFromMap(String str) => GetBasicProductoSolicitadoPocketbase.fromMap(json.decode(str));

String getBasicProductoSolicitadoPocketbaseToMap(GetBasicProductoSolicitadoPocketbase data) => json.encode(data.toMap());
...
class GetBasicProductoSolicitadoPocketbase {
    ...
    factory GetBasicProductoSolicitadoPocketbase.fromMap(Map<String, dynamic> json) => GetBasicProductoSolicitadoPocketbase(
        page: json["page"],
        perPage: json["perPage"],
        totalItems: json["totalItems"],
        items: List<ProductoSolicitado>.from(json["items"].map((x) => ProductoSolicitado.fromMap(x))),
    );
...
class ProductoSolicitadoExpand {
    ...
    final IdFpk idFamiliaProdFk;
    final IdTek idTipoEmpaquesFk;
    final IdImagenFk? idImagenFk;

    factory ProductoSolicitadoExpand.fromMap(Map<String, dynamic> json) => ProductoSolicitadoExpand(
        idFamiliaProdFk: IdFpk.fromMap(json["id_familia_prod_fk"]),
