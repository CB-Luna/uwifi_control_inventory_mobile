...
GetBasicProductosProyectoPocketbase getBasicProductosProyectoPocketbaseFromMap(String str) => GetBasicProductosProyectoPocketbase.fromMap(json.decode(str));

String getBasicProductosProyectoPocketbaseToMap(GetBasicProductosProyectoPocketbase data) => json.encode(data.toMap());
...
class GetBasicProductosProyectoPocketbase {
    ...
    factory GetBasicProductosProyectoPocketbase.fromMap(Map<String, dynamic> json) => GetBasicProductosProyectoPocketbase(
        page: json["page"],
        perPage: json["perPage"],
        totalItems: json["totalItems"],
        items: List<ProductoProyecto>.from(json["items"].map((x) => ProductoProyecto.fromMap(x))),
    );
...
class ProductoProyecto {
    ...
    factory ProductoProyecto.fromMap(Map<String, dynamic> json) => ProductoProyecto(
...
class ProductoProyectoExpand {
    ...
    final IdFpFk idFamiliaProdFk;
    final IdTeFk idTipoEmpaqueFk;

    factory ProductoProyectoExpand.fromMap(Map<String, dynamic> json) => ProductoProyectoExpand(
        idFamiliaProdFk: IdFpFk.fromMap(json["id_familia_prod_fk"]),
        idTipoEmpaqueFk: IdTeFk.fromMap(json["id_tipo_empaque_fk"]),
    );

    Map<String, dynamic> toMap() => {
        "id_familia_prod_fk": idFamiliaProdFk.toMap(),
