      ...
      switch (response.statusCode) {
        case 200: //Caso éxitoso
          final responseListFamiliaProducto = getFamiliaProductoEmiWebFromMap(
              const Utf8Decoder().convert(response.bodyBytes));
          for (var i = 0;
              i < responseListFamiliaProducto.payload!.length;
              i++) {
            ...
            final recordFamiliaProducto = await client.records.getFullList(
                ...
                batch: 200,
                filter:
                    "id_emi_web='${responseListFamiliaProducto.payload![i].idCatFamiliaInversion}'");
            if (recordFamiliaProducto.isEmpty) {
              //Se agrega el area circulo como nuevo en la colección de Pocketbase
              final recordFamiliaProducto =
                  await client.records.create('familia_prod', body: {
                "nombre_tipo_prod": responseListFamiliaProducto
                    .payload![i].familiaInversionNecesaria,
                "activo": responseListFamiliaProducto.payload![i].activo,
                "id_emi_web": responseListFamiliaProducto
                    .payload![i].idCatFamiliaInversion
                    .toString(),
              });
              if (recordFamiliaProducto.id.isNotEmpty) {
                print(
                    'Familia Producto Emi Web agregado éxitosamente a Pocketbase');
              } else {
                return false;
              }
            } else {
              //Se actualiza la familia producto en la colección de Pocketbase
              final recordFamiliaProductoParse = getFamiliaProductosFromMap(
                  recordFamiliaProducto.first.toString());
              //Verificamos que los campos de este registro sean diferentes para actualizarlo
              if (recordFamiliaProductoParse.nombreTipoProd !=
                      responseListFamiliaProducto
                          .payload![i].familiaInversionNecesaria ||
                  recordFamiliaProductoParse.activo !=
                      responseListFamiliaProducto.payload![i].activo) {
                final updateRecordFamiliaProducto = await client.records.update(
                    'familia_prod', recordFamiliaProductoParse.id,
                    body: {
                      "nombre_tipo_prod": responseListFamiliaProducto
                          .payload![i].familiaInversionNecesaria,
                      "activo": responseListFamiliaProducto.payload![i].activo,
                ...
                if (updateRecordFamiliaProducto.id.isNotEmpty) {
                  print(
                      'Familia Producto Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0; i < responseListUnidadMedida.payload!.length; i++) {
            ...
            if (recordUnidadMedida.isEmpty) {
              ...
              if (recordUnidadMedida.id.isNotEmpty) {
                print(
                    'Unidad de Medida Emi Web agregado éxitosamente a Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordUnidadMedidaParse.unidadMedida !=
                ...
                if (updateRecordUnidadMedida.id.isNotEmpty) {
                  print(
                      'Unidad de Medida Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0;
            ...
            if (recordAmbitoConsultoria.isEmpty) {
              ...
              if (recordAmbitoConsultoria.id.isNotEmpty) {
                print(
                    'Ámbito Consultoría Emi Web agregado éxitosamente a Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordAmbitoConsultoriaParse.nombreAmbito !=
                ...
                if (updateRecordAmbitoConsultoria.id.isNotEmpty) {
                  print(
                      'Ámbito Consultoría Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0; i < responseListAreaCirculo.payload!.length; i++) {
            ...
            if (recordAreaCirculo.isEmpty) {
              ...
              if (recordAreaCirculo.id.isNotEmpty) {
                print(
                    'Area Circulo Emi Web agregado éxitosamente a Pocketbase');
              } else {
                return false;
              }
            } else {
          ...
          for (var i = 0;
            ...
            if (recordFaseEmprendimiento.isEmpty) {
              ...
              if (newRecordFaseEmprendimiento.id.isNotEmpty) {
                print(
                    'Fase Emprendimiento Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordFaseEmprendimientoParse.fase !=
                ...
                if (updateRecordEstado.id.isNotEmpty) {
                  print(
                      'Fase Emprendimiento Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0; i < responseListTipoEmpaques.payload!.length; i++) {
            ...
            if (recordTipoEmpaque.isEmpty) {
              ...
              if (newRecordTipoEmpaque.id.isNotEmpty) {
                print(
                    'Tipo Empaque Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordTipoEmpaqueParse.tipoEmpaque !=
                ...
                if (updateRecordTipoEmpaque.id.isNotEmpty) {
                  print(
                      'Tipo Empaque Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0;
            ...
            if (recordEstadoInversion.isEmpty) {
              ...
              if (newRecordEstadoInversion.id.isNotEmpty) {
                print(
                    'Estado Inversión Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordEstadoInversionParse.estado !=
                ...
                if (updateRecordEstado.id.isNotEmpty) {
                  print(
                      'Estado Inversión Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
        ...
        case 200: //Caso éxitoso
          ...
          for (var i = 0; i < responseListTipoProveedor.payload!.length; i++) {
            ...
            if (recordTipoProveedor.isEmpty) {
              ...
              if (newRecordEstadoInversion.id.isNotEmpty) {
                print(
                    'Tipo Proveedor Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordTipoProveedorParse.tipoProveedor !=
                ...
                if (updateRecordTipoProveedor.id.isNotEmpty) {
                  print(
                      'Tipo Proveedor Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0; i < responseListCondicionPago.payload!.length; i++) {
            ...
            if (recordCondicionPago.isEmpty) {
              ...
              if (newRecordCondicionPago.id.isNotEmpty) {
                print(
                    'Condición Pago Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordCondicionPagoParse.condicionPago !=
                ...
                if (updateRecordTipoProveedor.id.isNotEmpty) {
                  print(
                      'Condición Pago Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
          ...
          for (var i = 0;
            ...
            if (recordPorcentajeAvance.isEmpty) {
              ...
              if (newRecordPorcentajeAvance.id.isNotEmpty) {
                print(
                    'Porcentaje Avance Emi Web agregado éxitosamente en Pocketbase');
              } else {
                return false;
              }
            } else {
              ...
              if (recordPorcentajeAvanceParse.porcentaje !=
                ...
                if (updateRecordPorcentajeAvance.id.isNotEmpty) {
                  print(
                      'Porcentaje Avance Emi Web actualizado éxitosamente en Pocketbase');
                } else {
                  return false;
                }
              }
                ...
                if (recordProveedor.isEmpty) {
                  ...
                  if (recordTipoProveedor.isNotEmpty &&
                    ...
                    if (recordProveedor.id.isNotEmpty) {
                      print(
                          'Proveedor Emi Web agregado éxitosamente a Pocketbase');
                    } else {
                      return false;
                    }
                  } else {
                  ...
                  if (recordProveedorParse.nombreFiscal !=
                    ...
                    if (updateRecordProveedor.id.isNotEmpty) {
                      print(
                          'Proveedor Emi Web actualizado éxitosamente en Pocketbase');
                    } else {
                      return false;
                    }
                  }
            ...
            switch (response.statusCode) {
              case 200: //Caso éxitoso
                ...
                if (recordProductoProveedor.isEmpty) {
                  ...
                  if (responseProductoProveedor.payload!.idDocumento != null) {
                    ...
                    switch (response.statusCode) {
                      case 200:
                        ...
                        final recordImagenProductoProveedor = await client.records.create('imagenes', body: {
                          "nombre": responseImagenProductoProveedor.payload!.nombreArchivo,
                          "base64": responseImagenProductoProveedor.payload!.archivo,
                        ...
                        if (recordImagenProductoProveedor.id.isNotEmpty) {
                          ...
                          final recordFamiliaProd = await client.records.getFullList(
                              ...
                              batch: 200,
                              filter:
                                  "id_emi_web='${responseProductoProveedor.payload!.idCatTipoProducto}'");
                          final recordUnidadMedida = await client.records.getFullList(
                              'und_medida',
                              batch: 200,
                              filter:
                          ...
                          if (recordProveedor.isNotEmpty &&
                            ...
                            final recordProductoProveedor =
                              ...
                              "costo_prod_prov":
                                  responseProductoProveedor.payload!.costoUnidadMedida,
                    ...
                    if (recordProveedor.isNotEmpty &&
                      ...
                      if (recordProductoProveedor.id.isNotEmpty) {
                        print(
                            'Producto Proveedor Emi Web agregado éxitosamente a Pocketbase');
                      } else {
                        return false;
                      }
                    } else {
                  ...
                  //Se verifica que el Producto Proveedor a agregar tenga una imagen asociada
                  if (responseProductoProveedor.payload!.idDocumento != null) {
                    //Se verifica si el Producto Proveedor existente ya tiene una imagen asociada o se debe crear
                    if (recordProductoProveedorParse.idImagenfk != "") {
                      //Se recupera la información de la Imagen y se actualiza en Pocketbase
                      var url = Uri.parse(
                        "$baseUrlEmiWebServices/documentos?id=${responseProductoProveedor.payload!.idDocumento}");
                      final headers = ({
                        "Content-Type": "application/json",
                      ...
                      switch (response.statusCode) {
                        case 200:
                          final responseImagenProductoProveedor =
                            getImagenProductoEmiWebFromMap(const Utf8Decoder()
                                .convert(response.bodyBytes));
                          final recordImagenProductoProveedor = await client.records.update('imagenes', recordProductoProveedorParse.idImagenfk, body: {
                            "nombre": responseImagenProductoProveedor.payload!.nombreArchivo,
                            "base64": responseImagenProductoProveedor.payload!.archivo,
                          }); 
                          if (recordImagenProductoProveedor.id.isNotEmpty) {
                            ...
                            if (recordProductoProveedorParse.nombreProdProv !=
                                    responseProductoProveedor.payload!.producto ||
                                recordProductoProveedorParse.descripcionProdProv !=
                                    responseProductoProveedor.payload!.descripcion ||
                                recordProductoProveedorParse.marca !=
                                    responseProductoProveedor.payload!.marca ||
                                recordProductoProveedorParse.costoProdProv !=
                                    responseProductoProveedor
                                        .payload!.costoUnidadMedida ||
                                recordProductoProveedorParse.tiempoEntrega !=
                                    responseProductoProveedor.payload!.tiempoEntrega ||
                                recordProductoProveedorParse.archivado !=
                              ...
                              if (updateRecordProductoProveedor.id.isNotEmpty) {
                                print(
                                    'Producto Proveedor Emi Web actualizado éxitosamente en Pocketbase');
                              } else {
                                return false;
                              }
                            }
                      ...
                      //Se recupera la información de la Imagen y se crea en Pocketbase
                      var url = Uri.parse(
                        "$baseUrlEmiWebServices/documentos?id=${responseProductoProveedor.payload!.idDocumento}");
                      final headers = ({
                        "Content-Type": "application/json",
                        ...
                        case 200:
                          ...
                          if (recordImagenProductoProveedor.id.isNotEmpty) {
                            ...
                            if (recordProductoProveedorParse.nombreProdProv !=
                                ...
                                recordProductoProveedorParse.archivado !=
                                    responseProductoProveedor.payload!.archivado ||
                                recordProductoProveedorParse.idImagenfk != 
                                recordImagenProductoProveedor.id ) {
                              //Se actualiza el producto proveedor en la colección de Pocketbase
                              final updateRecordProductoProveedor = await client.records
                                  .update(
                                      'productos_prov', recordProductoProveedorParse.id,
              ...
              case 200: //Caso éxitoso
                ...
                if (recordProductoProyecto.isEmpty) {
                  ...
                  final recordTipoEmpaque = await client.records.getFullList(
                      ...
                      filter:
                          "id_emi_web='${responseProductoProveedor.payload!.idUnidadMedida}'");
                  if (recordFamiliaProd.isNotEmpty &&
                  ...
                  if (recordProductoProyectoParse.producto !=
                    ...
                    final updateRecordProductoProyecto = await client.records
                        .update('prod_proyecto', recordProductoProyectoParse.id,
                          ...
                          "id_emi_web": responseListProdProyecto
                              .payload![i].producto!.idProductosProveedor
                              .toString(),
                        });
            ...
            case 200: //Caso éxitoso
              ...
              if (updateUsuario != null) {
                ...
                if (responseGetUsuarioDataCompletoParse.payload!.idDocumento ==
                  ...
                  print(
                      "ID Documento: ${responseGetUsuarioDataCompletoParse.payload!.idDocumento}");
                  var url = Uri.parse(
