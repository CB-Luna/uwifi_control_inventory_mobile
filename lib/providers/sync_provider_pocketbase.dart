...
class SyncProviderPocketbase extends ChangeNotifier {
      ...
      switch (instruccionesBitacora[i].instruccion) {
        case "syncAddImagenUsuario":
          ...
          if (imagenToSync != null) {
            ...
            final instruccionNoSincronizada = InstruccionNoSincronizada(
                instruccion:
                    "La instrucción para agregar Imagen de Perfil del Usuario en servidor local no pudo ejecutarse.",
                fecha: instruccionesBitacora[i].fechaRegistro);
            instruccionesFallidas.add(instruccionNoSincronizada);
            print(instruccionNoSincronizada.instruccion);
            continue;
        ...
        case "syncAddImagenJornada2":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncAddImagenJornada2 = await syncAddImagenJornada2(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncAddImagenJornada3":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncAddImagenJornada3 = await syncAddImagenJornada3(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncAddProductoInversionJ3":
          ...
          if (prodSolicitadoToSync != null) {
            final boolSyncAddProductoInversionJ3 =
        ...
        case "syncAddImagenJornada4":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncAddImagenJornada4 = await syncAddImagenJornada4(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncAddConsultoria":
          ...
          if (consultoriaToSync != null) {
            final boolSyncAddConsultoria = await syncAddConsultoria(
        ...
        case "syncAddProductoEmprendedor":
          ...
          if (productoEmpToSync != null) {
            final boolSyncAddProductoEmp = await syncAddProductoEmprendedor(
        ...
        case "syncAddImagenProductoEmprendedor":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncAddImagenProductoEmprendedor =
            ...
            if (boolSyncAddImagenProductoEmprendedor) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  instruccion:
                      "Agregar Imagen del Producto Emprendedor Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncAddProductoVendido":
          ...
          if (prodVendidoToSync != null) {
            final boolSyncAddProductoVendido = await syncAddProductoVendido(
        ...
        case "syncAddSingleProductoVendido":
          ...
          final prodVendidoToSync = getFirstProductoVendido(
              ...
              instruccionesBitacora[i].id);
          if (prodVendidoToSync != null) {
            final boolSyncAddSingleProductoVendido =
        ...
        case "syncAddInversion":
          ...
          if (inversionToSync != null) {
            final boolSyncAddInversion = await syncAddInversion(
        ...
        case "syncUpdateFaseEmprendimiento":
          ...
          final emprendimientoToSync = getFirstEmprendimiento(
              ...
              instruccionesBitacora[i].id);
          if (emprendimientoToSync != null) {
            final boolSyncUpdateFaseEmprendimiento =
            ...
            if (boolSyncUpdateFaseEmprendimiento) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  emprendimiento: emprendimientoToSync.nombre,
                  instruccion:
                      "Actualización Fase Emprendimiento a ${instruccionesBitacora[i].instruccionAdicional} Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncUpdateImagenUsuario":
          ...
          if (imagenToSync != null) {
            ...
            final instruccionNoSincronizada = InstruccionNoSincronizada(
                instruccion:
                    "La instrucción para actualizar Imagen de Perfil del Usuario en servidor local no pudo ejecutarse.",
                fecha: instruccionesBitacora[i].fechaRegistro);
            instruccionesFallidas.add(instruccionNoSincronizada);
            print(instruccionNoSincronizada.instruccion);
            continue;
        ...
        case "syncUpdateEmprendedor":
          ...
          final emprendedorToSync = getFirstEmprendedor(
              dataBase.emprendedoresBox.getAll(), instruccionesBitacora[i].id);
          if (emprendedorToSync != null) {
            final boolSyncUpdateEmprendedor = await syncUpdateEmprendedor(
                emprendedorToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateEmprendimiento":
          ...
          final emprendedorToSync = getFirstEmprendimiento(
              ...
              instruccionesBitacora[i].id);
          if (emprendedorToSync != null) {
            final boolSyncUpdateEmprendimiento = await syncUpdateEmprendimiento(
                emprendedorToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateJornada1":
          ...
          final jornadaToSync = getFirstJornada(
              dataBase.jornadasBox.getAll(), instruccionesBitacora[i].id);
          if (jornadaToSync != null) {
            final boolSyncUpdateJornada1 = await syncUpdateJornada1(
        ...
        case "syncUpdateJornada2":
          ...
          final jornadaToSync = getFirstJornada(
              dataBase.jornadasBox.getAll(), instruccionesBitacora[i].id);
          if (jornadaToSync != null) {
            final boolSyncUpdateJornada2 = await syncUpdateJornada2(
                jornadaToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateImagenJornada2":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncUpdateImagenJornada2 = await syncUpdateImagenJornada2(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateJornada3":
          ...
          final jornadaToSync = getFirstJornada(
              dataBase.jornadasBox.getAll(), instruccionesBitacora[i].id);
          if (jornadaToSync != null) {
            final boolSyncUpdateJornada3 = await syncUpdateJornada3(
                jornadaToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateImagenJornada3":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncUpdateImagenJornada3 = await syncUpdateImagenJornada3(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateProductoInversionJ3":
          ...
          final prodSolicitadoToSync = getFirstProdSolicitado(
              ...
              instruccionesBitacora[i].id);
          if (prodSolicitadoToSync != null) {
            final boolSyncUpdateProductoInversionJ3 =
            ...
            if (boolSyncUpdateProductoInversionJ3) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  emprendimiento: prodSolicitadoToSync
                      .inversion.target!.emprendimiento.target!.nombre,
                  instruccion:
                      "Actualización Producto Inversión Jornada 3 Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncUpdateJornada4":
          ...
          final jornadaToSync = getFirstJornada(
              dataBase.jornadasBox.getAll(), instruccionesBitacora[i].id);
          if (jornadaToSync != null) {
            final boolSyncUpdateJornada4 = await syncUpdateJornada4(
                jornadaToSync, instruccionesBitacora[i]);
        ...
        case "syncUpdateImagenJornada4":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncUpdateImagenJornada4 = await syncUpdateImagenJornada4(
                imagenToSync, instruccionesBitacora[i]);
        ...
        case "syncDeleteImagenJornada":
          ...
          final boolSyncDeleteImagenJornada =
          ...
          if (boolSyncDeleteImagenJornada) {
            ...
            final instruccionNoSincronizada = InstruccionNoSincronizada(
                ...
                instruccion:
                    "Eliminar ${instruccionesBitacora[i].instruccionAdicional} Servidor",
                fecha: instruccionesBitacora[i].fechaRegistro);
            // instruccionesFallidas.add(instruccionNoSincronizada);
            print(instruccionNoSincronizada.instruccion);
            continue;
        ...
        case "syncDeleteProductoInversionJ3":
          ...
          final boolSyncDeleteProductoInversionJ3 =
        ...
        case "syncUpdateTareaConsultoria":
          ...
          if (tareaToSync != null) {
            final boolSyncUpdateTareaConsultoria =
        ...
        case "syncUpdateEstadoInversion":
          ...
          final inversionToSync = getFirstInversion(
              dataBase.inversionesBox.getAll(), instruccionesBitacora[i].id);
          if (inversionToSync != null) {
            final boolSyncUpdateEstadoInversion =
        ...
        case "syncUpdateProductoEmprendedor":
          ...
          if (productoEmprendedorToSync != null) {
            final boolSyncUpdateProductoEmprendedor =
        ...
        case "syncUpdateImagenProductoEmprendedor":
          ...
          final imagenToSync = getFirstImagen(
              dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
          if (imagenToSync != null) {
            final boolSyncUpdateImagenProdEmprendedor =
            ...
            if (boolSyncUpdateImagenProdEmprendedor) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  instruccion:
                      "Actualización Imagen del Producto Emprendedor Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncUpdateProductoVendido":
          ...
          final prodVendidoToSync = getFirstProductoVendido(
              ...
              instruccionesBitacora[i].id);
          if (prodVendidoToSync != null) {
            final boolSyncUpdateProductoVendido =
        ...
        case "syncUpdateProductosVendidosVenta":
          ...
          final ventaToSync = getFirstVenta(
              dataBase.ventasBox.getAll(), instruccionesBitacora[i].id);
          if (ventaToSync != null) {
            final boolSyncUpdateProductosVendidosVenta =
            ...
            if (boolSyncUpdateProductosVendidosVenta) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  emprendimiento: ventaToSync.emprendimiento.target!.nombre,
                  instruccion:
                      "Actualización Productos Vendidos Venta Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncArchivarEmprendimiento":
          ...
          final emprendedorToSync = getFirstEmprendimiento(
              ...
              instruccionesBitacora[i].id);
          if (emprendedorToSync != null) {
            final boolSyncArchivarEmprendimiento =
        ...
        case "syncDesarchivarEmprendimiento":
          ...
          final emprendedorToSync = getFirstEmprendimiento(
              ...
              instruccionesBitacora[i].id);
          if (emprendedorToSync != null) {
            final boolSyncDesarchivarEmprendimiento =
        ...
        case "syncArchivarConsultoria":
          ...
          final consultoriaToSync = getFirstConsultoria(
              dataBase.consultoriasBox.getAll(), instruccionesBitacora[i].id);
          if (consultoriaToSync != null) {
            final boolSyncArchivarConsultoria = await syncArchivarConsultoria(
                consultoriaToSync, instruccionesBitacora[i]);
        ...
        case "syncDesarchivarConsultoria":
          ...
          final consultoriaToSync = getFirstConsultoria(
              dataBase.consultoriasBox.getAll(), instruccionesBitacora[i].id);
          if (consultoriaToSync != null) {
            final boolSyncDesarchivarConsultoria =
        ...
        case "syncAcceptInversionXProdCotizado":
          ...
          if (inversionXproductoCotizadoToSync != null) {
            final boolSyncAcceptInversionXProductoCotizado =
            ...
            if (boolSyncAcceptInversionXProductoCotizado) {
              ...
              final instruccionNoSincronizada = InstruccionNoSincronizada(
                  emprendimiento: inversionXproductoCotizadoToSync
                      .inversion.target!.emprendimiento.target!.nombre,
                  instruccion:
                      "Aceptar Inversion por Productos Cotizados Servidor",
                  fecha: instruccionesBitacora[i].fechaRegistro);
              // instruccionesFallidas.add(instruccionNoSincronizada);
              print(instruccionNoSincronizada.instruccion);
              continue;
        ...
        case "syncAcceptProdCotizado":
          ...
          if (productoCotizadoToSync != null) {
            final boolSyncAcceptProductoCotizado = await syncAcceptProdCotizado(
        ...
        case "syncDeleteProductoVendido":
          ...
          final boolSyncDeleteProductoVendido =
        ...
        case "syncAddPagoInversion":
          ...
          if (pagoToSync != null) {
            final boolSyncAddPago = await syncAddPagoInversion(
        ...
        case "syncAddImagenesEntregaInversion":
          ...
          final inversionToSync = getFirstInversion(
              dataBase.inversionesBox.getAll(), instruccionesBitacora[i].id);
          if (inversionToSync != null) {
            final boolSyncAddImagenesEntregaInversion =
  ...
  Future<bool> syncAddProductoInversionJ3(
  ...
  Future<bool> syncUpdateProductoInversionJ3(
      ProdSolicitado prodSolicitado, Bitacora bitacora) async {
  ...
  Future<bool> syncAddConsultoria(
  ...
  Future<bool> syncAddProductoEmprendedor(
  ...
  Future<bool> syncAddImagenProductoEmprendedor(
  ...
  Future<bool> syncAddProductoVendido(
  ...
  Future<bool> syncAddSingleProductoVendido(
      ProdVendidos productoVendido, Bitacora bitacora) async {
  ...
  Future<bool?> syncUpdateEstadoConsultoria(Consultorias consultoria) async {
    ...
    try {
      final record = await client.records
          .update('consultorias', consultoria.idDBR!, body: {
        "id_ambito_fk": consultoria.ambitoConsultoria.target!.idDBR,
        "id_area_circulo_fk": consultoria.areaCirculo.target!.idDBR,
  ...
  Future<bool> syncUpdateTareaConsultoria(
  ...
  Future<bool> syncUpdateProductoEmprendedor(
  ...
  Future<bool> syncUpdateImagenProductoEmprendedor(
      Imagenes imagen, Bitacora bitacora) async {
      ...
      if (!bitacora.executePocketbase) {
        ...
        if (recordImagen.id.isNotEmpty) {
          final recordProductoEmp = await client.records.update(
              'productos_emp', imagen.productosEmp.target!.idDBR.toString(),
              body: {
  ...
  Future<bool> syncUpdateProductosVendidosVenta(
  ...
  Future<bool> syncAcceptInversionesXProductosCotizados(
  ...
  Future<bool> syncAcceptProdCotizado(
  ...
  Future<bool> syncUpdateProductoVendido(
      ProdVendidos productoVendido, Bitacora bitacora) async {
  ...
  Future<bool> syncArchivarEmprendimiento(
      Emprendimientos emprendimiento, Bitacora bitacora) async {
  ...
  Future<bool> syncDesarchivarEmprendimiento(
      Emprendimientos emprendimiento, Bitacora bitacora) async {
  ...
  Future<bool> syncArchivarConsultoria(
      Consultorias consultoria, Bitacora bitacora) async {
  ...
  Future<bool> syncDesarchivarConsultoria(
      Consultorias consultoria, Bitacora bitacora) async {
...
// }
  ...
  Future<bool?> syncDeleteProductoSolicitado(
      String idDBRProductoSolicitado) async {
    try {
      print("Estoy en syncDeleteProductoSolicitado");
      //Validamos que el elemento exista en el backend
      final record = await client.records
          .getOne('productos_solicitados', idDBRProductoSolicitado);
      if (record.id.isNotEmpty) {
        //Se puede eliminar el producto solicitado en el backend
        await client.records
            .delete('productos_solicitados', idDBRProductoSolicitado);
  ...
  Future<bool> syncAddImagenesEntregaInversion(
      Inversiones inversion, Bitacora bitacora) async {
