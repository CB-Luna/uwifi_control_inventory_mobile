  ...
  void updateRecepcionInversion() {
   ...
   void finishRecepcionInversion() {
    ...
    final updateInversionXprodCotizado = dataBase.inversionesXprodCotizadosBox.get(inversionXProdCotizadosTemp!.id);
       if (updateInversionXprodCotizado != null) {
        final nuevaInstruccion = Bitacora(instrucciones: 'syncUpdateInversionXProdCotizado', usuario: prefs.getString("userId")!); //Se crea la nueva instruccion a realizar en bitacora
        ...
        updateInversionXprodCotizado.bitacora.add(nuevaInstruccion);
   ...
   void entregaInversion(String imagenFirma, String imagenProducto, int idInversion) {
    ...
    if (updateInversion != null) {
      final nuevaInstruccion = Bitacora(instrucciones: 'syncUpdateImagenInversion', usuario: prefs.getString("userId")!); //Se crea la nueva instruccion a realizar en bitacora
