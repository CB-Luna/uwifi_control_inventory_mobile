...
import 'package:taller_alex_app_asesor/modelsEmiWeb/get_emprendimiento_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/get_inversion_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/get_prod_cotizados_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/get_productos_vendidos_emi_web.dart';
...
import 'package:taller_alex_app_asesor/modelsEmiWeb/post_registro_exitoso_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/post_registro_exitoso_emi_web_single.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/post_registro_imagen_exitoso_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/post_simple_registro_exitoso_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/temporals/get_validate_usuaio_estatus_emi_web.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/venta_actualizar_request_list.dart';
import 'package:taller_alex_app_asesor/modelsEmiWeb/venta_crear_request_list_emi_web.dart';
        ...
        for (var i = 0; i < instruccionesBitacora.length; i++) {
          ...
          switch (instruccionesBitacora[i].instruccion) {
            ...
            case "syncUpdateInversionXProdCotizado":
              //print("Entro al caso de syncUpdateInversionXProdCotizado Emi Web");
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final inversionXproductoCotizadoToSync =
                    getFirstInversionXProductosCotizados(
                        dataBase.inversionesXprodCotizadosBox.getAll(),
