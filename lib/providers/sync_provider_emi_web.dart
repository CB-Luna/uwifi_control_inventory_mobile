...
//Función inicial para recuperar el Token para la sincronización/posteo de datos
      ...
      if (updateUsuario != null) {
        switch (response.statusCode) {
          case 200:
            ...
            var responseGetRolesUsuario =
                await get(urlgetRolesUsuario, headers: headers);
            switch (responseGetRolesUsuario.statusCode) {
              case 200: //Caso éxitoso
                ...
                final responseListRoles = getRolesEmiWebFromMap(
                    const Utf8Decoder()
                        .convert(responseGetRolesUsuario.bodyBytes));
                ...
                for (var i = 0; i < responseListRoles.payload!.length; i++) {
                  ...
                  if (rol != null) {
                    print(
                        "Se recupera el rol tipo: '${rol.rol}' del usuario a registrar con id: '${rol.idDBR}'");
                ...
                if (listRoles.isEmpty) {
                  ...
                  if (updateRecordEmiUser.id.isNotEmpty) {
                    ...
                    snackbarKey.currentState?.showSnackBar(const SnackBar(
                      content: Text(
                          "No se pudieron actualizar los roles del Usuario en Servidor."),
                    ));
                    return false;
                  }
                } else {
                  ...
                  if (updateRecordEmiUser.id.isNotEmpty) {
                    ...
                    for (var i = 0; i < listRoles.length; i++) {
                      final nuevoRol = dataBase.rolesBox
                          .query(Roles_.idDBR.equals(listRoles[i]))
                          .build()
                    ...
                    final rolActual = dataBase.rolesBox
                        .query(Roles_.idDBR.equals(listRoles[0]))
                        .build()
  ...
  Future<bool> executeInstrucciones(
      List<Bitacora> instruccionesBitacora) async {
    ...
    if (usuarioActual != null) {
      ...
      if (await getTokenOAuth()) {
        for (var i = 0; i < instruccionesBitacora.length; i++) {
          print(
              "Tamaño instrucciones Emi Web: ${instruccionesBitacora.length}");
          print(
              "Instrucción a realizar en Emi Web: ${instruccionesBitacora[i].instruccion}");
          switch (instruccionesBitacora[i].instruccion) {
            case "syncAddImagenUsuario":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (imagenToSync != null) {
                  ...
                  final boolSyncAddImagenUsuario = await syncAddImagenUsuario(
                ...
                if (emprendedorToSync != null) {
                  ...
                  if (boolSyncAddEmprendedor != null) {
                    if (boolSyncAddEmprendedor) {
                      ...
                      //Recuperamos la instrucción que no se ejecutó
                      banderasExistoSync.add(boolSyncAddEmprendedor);
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: emprendedorToSync
                    ...
                    final instruccionNoSincronizada = InstruccionNoSincronizada(
                        ...
                        instruccion:
                            "El emprendedor ya se encuentra registrado en Emi Web",
                        fecha: instruccionesBitacora[i].fechaRegistro);
                    instruccionesFallidas.add(instruccionNoSincronizada);
                    continue;
                  }
            ...
            case "syncAddEmprendimiento":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (emprendimientoToSync != null) {
                  ...
                  final boolSyncAddEmprendimiento =
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (jornadaToSync != null) {
                  ...
                  final nombreEmprendimiento =
                      jornadaToSync.emprendimiento.target!.nombre;
            ...
            case "syncAddImagenJornada2":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (imagenToSync != null) {
                  ...
                  final nombreEmprendimiento = imagenToSync.tarea.target!
                      .jornada.target?.emprendimiento.target?.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
            ...
            case "syncAddProductoInversionJ3":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (prodSolicitadoToSync != null) {
                  ...
                  final nombreEmprendimiento = prodSolicitadoToSync
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Agregar Producto Inversión Jornada 3 Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                  ...
                  switch (caseSyncUpdateProductoInversionJ3) {
                    case 0:
                      ...
                      final instruccionNoSincronizada = InstruccionNoSincronizada(
                          emprendimiento: nombreEmprendimiento,
                          instruccion:
                              "Actualización Producto Inversión Jornada 3 Emi Web",
                          fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncAddConsultoria":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final consultoriaToSync = getFirstConsultoria(
                    dataBase.consultoriasBox.getAll(),
                    instruccionesBitacora[i].id);
            ...
            case "syncAddProductoEmprendedor":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final productoEmpToSync = getFirstProductoEmprendedor(
                    dataBase.productosEmpBox.getAll(),
                    instruccionesBitacora[i].id);
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Agregar Producto Emprendedor Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncAddImagenProductoEmprendedor":
              print(
                  "Entro al caso de syncAddImagenProductoEmprendedor Emi Web");
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final imagenToSync = getFirstImagen(
                    dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
                if (imagenToSync != null) {
                  //Se encontró a la imagen y se puede agregar
                  final nombreEmprendimiento = imagenToSync
                      .productosEmp.target?.emprendimientos.target?.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
                  ...
                  switch (caseSyncAddImagenProdEmprendedor) {
                    case 0:
                      ...
                      final instruccionNoSincronizada = InstruccionNoSincronizada(
                          emprendimiento: nombreEmprendimiento,
                          instruccion:
                              "Agregar Imagen del Producto Emprendedor Emi Web",
                          fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncAddVenta":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (ventaToSync != null) {
                  ...
                  final nombreEmprendimiento =
                      ventaToSync.emprendimiento.target!.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
            ...
            case "syncAddProductoVendido":
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (prodVendidoToSync != null) {
                  ...
                  final nombreEmprendimiento = prodVendidoToSync
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Agregar un Producto Vendido en Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncAddInversion":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final inversionToSync = getFirstInversion(
                    dataBase.inversionesBox.getAll(),
                    instruccionesBitacora[i].id);
                if (inversionToSync != null) {
                  //Se encontró la inversión y se puede agregar
                  final nombreEmprendimiento =
                      inversionToSync.emprendimiento.target!.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
            ...
            case "syncUpdateUsuario":
              ...
              if (usuarioToSync != null) {
                ...
                final boolSyncUpdateUsuario = await syncUpdateUsuario(
            ...
            case "syncUpdateImagenUsuario":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (imagenToSync != null) {
                  ...
                  final boolSyncUpdateUsuario = await syncUpdateImagenUsuario(
                      imagenToSync, instruccionesBitacora[i]);
                  if (boolSyncUpdateUsuario) {
                    banderasExistoSync.add(boolSyncUpdateUsuario);
                    continue;
                    ...
                    final instruccionNoSincronizada = InstruccionNoSincronizada(
                        instruccion:
                            "Actualización Imagen de Perfil Usuario Emi Web",
                        fecha: instruccionesBitacora[i].fechaRegistro);
                    instruccionesFallidas.add(instruccionNoSincronizada);
                    continue;
                  }
                  ...
                  switch (caseSyncUpdateFaseEmprendimiento) {
                    case 0:
                      ...
                      final instruccionNoSincronizada = InstruccionNoSincronizada(
                          emprendimiento: nombreEmprendimiento,
                          instruccion:
                              "Actualización Fase Emprendimiento a ${instruccionesBitacora[i].instruccionAdicional} Emi Web",
                          fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualización Emprendimiento Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualizar Imagen Jornada 2 Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualizar Imagen Jornada 3 Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualizar Imagen Jornada 4 Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualizar Estado Inversión Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncUpdateTareaConsultoria":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (tareaToSync != null) {
                  ...
                  final nombreEmprendimiento = tareaToSync
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualización Tarea Consultoría Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncUpdateProductoEmprendedor":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (productoEmprendedorToSync != null) {
                  ...
                  final nombreEmprendimiento =
                      productoEmprendedorToSync.emprendimientos.target!.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
                  var caseSyncUpdateProductoEmprendedor =
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualización Producto Emprendedor Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncUpdateImagenProductoEmprendedor":
              print(
                  "Entro al caso de syncUpdateImagenProductoEmprendedor Emi Web");
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final imagenToSync = getFirstImagen(
                    dataBase.imagenesBox.getAll(), instruccionesBitacora[i].id);
                if (imagenToSync != null) {
                  ...
                  switch (caseSyncUpdateImagenProdEmprendedor) {
                    case 0:
                      ...
                      final instruccionNoSincronizada = InstruccionNoSincronizada(
                          emprendimiento: nombreEmprendimiento,
                          instruccion:
                              "Actualización Imagen del Producto Emprendedor Emi Web",
                          fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Actualización Producto Vendido Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncUpdateProductosVendidosVenta":
              print(
                  "Entro al caso de syncUpdateProductosVendidosVenta Emi Web");
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final ventaToSync = getFirstVenta(
                    dataBase.ventasBox.getAll(), instruccionesBitacora[i].id);
                if (ventaToSync != null) {
                  ...
                  switch (caseSyncUpdateProductosVendidosVenta) {
                    case 0:
                      ...
                      final instruccionNoSincronizada = InstruccionNoSincronizada(
                          emprendimiento: nombreEmprendimiento,
                          instruccion:
                              "Actualización Productos Vendidos Venta Emi Web",
                          fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncDeleteImagenJornada":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                final nombreEmprendimiento =
                    instruccionesBitacora[i].emprendimiento;
                final idEmprendimientoMensaje =
                    instruccionesBitacora[i].idEmprendimiento;
                ...
                switch (caseSyncDeleteImagenJornada) {
                  case 0:
                    ...
                    final instruccionNoSincronizada = InstruccionNoSincronizada(
                        emprendimiento: nombreEmprendimiento,
                        instruccion:
                            "Eliminar ${instruccionesBitacora[i].instruccionAdicional} Emi Web",
                        fecha: instruccionesBitacora[i].fechaRegistro);
                    instruccionesFallidas.add(instruccionNoSincronizada);
                    continue;
                  case 1:
                ...
                switch (caseSyncDeleteProductoInversionJ3) {
                  case 0:
                    ...
                    final instruccionNoSincronizada = InstruccionNoSincronizada(
                        emprendimiento: nombreEmprendimiento,
                        instruccion:
                            "Eliminar Producto Inversión Jornada 3 Emi Web",
                        fecha: instruccionesBitacora[i].fechaRegistro);
                    instruccionesFallidas.add(instruccionNoSincronizada);
                    continue;
                  case 1:
            ...
            case "syncAcceptInversionXProdCotizado":
              print(
                  "Entro al caso de syncAcceptInversionXProdCotizado Emi Web");
              if (!instruccionesBitacora[i].executeEmiWeb) {
                    ...
                    case 0:
                      ...
                      final instruccionNoSincronizada =
                          InstruccionNoSincronizada(
                              emprendimiento: nombreEmprendimiento,
                              instruccion:
                                  "Agregar Imagénes Entrega Inversión Emi Web",
                              fecha: instruccionesBitacora[i].fechaRegistro);
                      instruccionesFallidas.add(instruccionNoSincronizada);
                      continue;
                    case 1:
            ...
            case "syncAddPagoInversion":
              ...
              if (!instruccionesBitacora[i].executeEmiWeb) {
                ...
                if (pagoToSync != null) {
                  ...
                  final nombreEmprendimiento = pagoToSync
                      .inversion.target!.emprendimiento.target!.nombre;
                  final idEmprendimientoMensaje =
                      instruccionesBitacora[i].idEmprendimiento;
  ...
  Future<bool?> syncAddEmprendedor(
    ...
    try {
        ...
        if (emprendedor.idEmiWeb == null) {
          ...
          final responsePostEmprendedor = await post(crearEmprendedorUri,
              ...
              body: jsonEncode({
                ...
                "fechaRegistro": (DateFormat("yyyy-MM-ddTHH:mm:ss")
                        .format(emprendedor.fechaRegistro))
                    .toString(),
                "archivado": false
              }));
          ...
          switch (responsePostEmprendedor.statusCode) {
            case 200:
              ...
              final responseGetEmprendimiento = await get(
                obtenerEmprendimientoUri,
                headers: headers,
              );
              ...
              switch (responseGetEmprendimiento.statusCode) {
                case 200:
                  ...
                  final responseGetEmprendimientoParse =
                      getEmprendimientoEmiWebFromMap(const Utf8Decoder()
                          .convert(responseGetEmprendimiento.bodyBytes));
                  //Se agrega el API adicional que indica quién es el Usuario propietario del proyecto
                  final actualizarUsuarioUri = Uri.parse(
                      '$baseUrlEmiWebServices/proyectos/status?idProyecto=${responseGetEmprendimientoParse.payload!.id}');
                  final headers = ({
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer $tokenGlobal',
                  });
      ...
      //Fallo en el momento se sincronizar
              ...
              if (jornada.idEmiWeb == null) {
                ...
                final responsePostJornada = await post(crearJornadaUri,
                    ...
                    body: jsonEncode({
                      ...
                      "fechaRegistro": DateFormat("yyyy-MM-ddTHH:mm:ss")
                          .format(jornada.fechaRegistro),
                      "registrarTarea": jornada.tarea.target!.tarea,
                      "fechaRevision": DateFormat("yyyy-MM-ddTHH:mm:ss")
                          .format(jornada.fechaRevision),
                ...
                switch (responsePostJornada.statusCode) {
                  case 200:
                    ...
                    final responsePostJornadaParse =
                        postRegistroExitosoEmiWebFromMap(const Utf8Decoder()
                            .convert(responsePostJornada.bodyBytes));
                ...
                switch (responsePostJornada.statusCode) {
                  case 200:
                    ...
                    for (var i = 0;
                      ...
                      final responsePostImagenJornada =
                          await post(crearImagenJornadaUri,
                              headers: headers,
                              body: jsonEncode({
                                "idCatTipoDocumento": "4", //Círculo Empresa
                                "nombreArchivo": jornada.tarea.target!.imagenes
                                    .toList()[i]
                                    .nombre,
                                "archivo": jornada.tarea.target!.imagenes
                                    .toList()[i]
                                    .base64,
  ...
  Future<int> syncAddImagenJornada2(
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responsePostAddImagenJornada2 =
                await post(crearImagenJornada2Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idCatTipoDocumento": "4", //Círculo Empresa
              ...
              if (jornada.idEmiWeb == null) {
                ...
                switch (responsePostJornada.statusCode) {
                  case 200:
                    ...
                    final responseUpdateTipoProyectoEmprendimiento =
                        await put(updateTipoProyectoEmprendimientoUri,
                            headers: headers,
                            body: jsonEncode({
                    ...
                    switch (
                      ...
                      case 200:
                        ...
                        print(
                            "Caso 200 en Emi Web Actualización Tipo de Proyecto");
                        for (var i = 0;
                            i < jornada.tarea.target!.imagenes.toList().length;
                            i++) {
                          ...
                          final responsePostImagenJornada = await post(
                              crearImagenJornadaUri,
                              headers: headers,
                              body: jsonEncode({
                        ...
                        final inversionJornada3 = dataBase.inversionesBox.get(
                            jornada.emprendimiento.target?.idInversionJornada ??
                                -1);
                          ...
                          for (var i = 0;
                            ...
                            if (inversionJornada3.prodSolicitados
                              ...
                              if (inversionJornada3.prodSolicitados
                                ...
                                final crearProductoProyectoUri = Uri.parse(
                                    '$baseUrlEmiWebServices/productos/proyectos');
                                final headers = ({
                                  "Content-Type": "application/json",
                                  'Authorization': 'Bearer $tokenGlobal',
                                });
                                final responsePostProductoProyecto =
                                    await post(crearProductoProyectoUri,
                                        headers: headers,
                                        body: jsonEncode({
                                          ...
                                          "producto": inversionJornada3
                                              ...
                                              .toList()[i]
                                              .producto,
                                          "descripcion": inversionJornada3
                                              .prodSolicitados
                                              .toList()[i]
                                              .descripcion,
                                          "marcaRecomendada": inversionJornada3
                                              .prodSolicitados
                                              .toList()[i]
                                              .marcaSugerida,
                                          "cantidad": inversionJornada3
                                              .prodSolicitados
                                              .toList()[i]
                                              .cantidad,
                                          "costoEstimado": inversionJornada3
                                              .prodSolicitados
                                              .toList()[i]
                                              .costoEstimado,
                                          "proveedorSugerido": inversionJornada3
                                              .prodSolicitados
                                              .toList()[i]
                                              .proveedorSugerido,
                                          "idProyecto": jornada
                      ...
                      default: //No se realizo con éxito el post
                        print(
                            "Error en actualizar tipo proyecto de emprendimiento");
                        return 0;
                    }
                  default: //No se realizo con éxito el post
                    print("Error en postear jornada Emi Web");
  ...
  Future<int> syncAddImagenJornada3(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responsePostAddImagenJornada3 =
                await post(crearImagenJornada3Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idCatTipoDocumento": "5", //Análisis Financiero
                      "nombreArchivo": imagen.nombre,
              ...
              if (jornada.idEmiWeb == null) {
                ...
                for (var i = 0; i < listJornadas.length; i++) {
                  if (listJornadas[i].numJornada != "4") {
                    ...
                    final responseUpdateJornada =
                        await put(actualizarJornada1Uri,
                            headers: headers,
                            body: jsonEncode({
                              "idUsuario": listJornadas[i]
                                  .emprendimiento
                                  .target!
                                  .usuario
                                  .target!
                              ...
                              "fechaRegistro": DateFormat("yyyy-MM-ddTHH:mm:ss")
                                  .format(listJornadas[i].fechaRegistro),
                              "registrarTarea":
                                  listJornadas[i].tarea.target!.tarea,
                              "fechaRevision": DateFormat("yyyy-MM-ddTHH:mm:ss")
                                  .format(listJornadas[i].fechaRevision),
                              "comentarios":
                                  listJornadas[i].tarea.target!.comentarios,
                              "tareaCompletada": true,
                              "descripcion":
                                  listJornadas[i].tarea.target!.descripcion,
  ...
  Future<int> syncAddProductoInversionJ3(ProdSolicitado prodSolicitado,
  ...
  Future<int> syncAddImagenJornada4(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responsePostAddImagenJornada4 =
                await post(crearImagenJornada4Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idCatTipoDocumento": "6", //Convenio
                      "nombreArchivo": imagen.nombre,
                ...
                final responsePostConsultoria = await post(crearConsultoriaUri,
                    ...
                    body: jsonEncode({
                      ...
                      "archivado":
                          false, //Es falso por que apenas la estamos dando de alta
                      "fechaRegistro": DateFormat("yyyy-MM-ddTHH:mm:ss")
                          .format(consultoria.tareas.first.fechaRegistro),
                    }));
  ...
  Future<int> syncAddProductoEmprendedor(
          ...
          try {
            ...
            if (imagenToSync != null) {
              ...
              if (imagenToSync.idEmiWeb == null) {
                ...
                final responsePostImagenProductoEmp =
                    await post(crearImagenProductoEmpUri,
                        headers: headers,
                        body: jsonEncode({
                ...
                switch (responsePostImagenProductoEmp.statusCode) {
                  case 200:
                    ...
                    final responsePostImagenProductoEmpParse =
                        postRegistroImagenExitosoEmiWebFromMap(
                            const Utf8Decoder().convert(
                    ...
                    print(
                        "Id Imagen Emi Web Prod EMPRENDEDOR: ${responsePostImagenProductoEmpParse.payload.idDocumento.toString()}");
                    ...
                    final responsePostProductoEmprendedor =
                        await post(crearProductoEmprendedorUri,
                            headers: headers,
                            body: jsonEncode({
                    ...
                    switch (responsePostProductoEmprendedor.statusCode) {
                      case 200:
                        ...
                        final responsePostProductoEmprendedorParse =
                            postRegistroExitosoEmiWebSingleFromMap(
                                const Utf8Decoder().convert(
  ...
  Future<int> syncAddImagenProductoEmprendedor(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            print(imagen.nombre);
            print(imagen.base64);
            print(imagen.productosEmp.target!.emprendimientos.target!.usuario
                .target!.idEmiWeb);
            ...
            switch (responsePostAddImagenProductoEmprendedor.statusCode) {
              case 200:
                print("Caso 200 en Emi Web Add Imagen Usuario");
                //Se recupera el id Emi Web
                final responsePostImagenProductoEmprendedorParse =
                    postRegistroImagenExitosoEmiWebFromMap(const Utf8Decoder()
              ...
              switch (responsePostVenta.statusCode) {
                case 200:
                  ...
                  final obtenerProductosVendidosUri = Uri.parse(
                      '$baseUrlEmiWebServices/ventas/${responsePostVentaParse.payload.toString()}');
                  final headers = ({
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer $tokenGlobal',
                  });
                  final responseGetProductosVendidos = await get(
                    obtenerProductosVendidosUri,
                    headers: headers,
                  );
                  ...
                  switch (responseGetProductosVendidos.statusCode) {
                    case 200:
                      ...
                      final responseGetProductosVendidosParse =
                          getProductosVendidosEmiWebFromMap(const Utf8Decoder()
                              .convert(responseGetProductosVendidos.bodyBytes));
                      for (var i = 0;
                          i <
                              responseGetProductosVendidosParse.payload!
                                  .ventasXProductoEmprenedorList!.length;
                          i++) {
                        for (var element in venta.prodVendidos.toList()) {
                          if (element.nombreProd ==
                            ...
                            if (venta.prodVendidos.toList()[i].idEmiWeb ==
                              ...
                              venta.prodVendidos.toList()[i].idEmiWeb =
                                  responseGetProductosVendidosParse.payload!
                                      ...
                                      .toString();
                              dataBase.productosVendidosBox
                                  .put(venta.prodVendidos.toList()[i]);
                            }
                          }
                        }
                      }
              ...
              switch (responseGetProductosVendidos.statusCode) {
                case 200:
                  ...
                  for (var i = 0;
                      i <
                          responseGetProductosVendidosParse
                              .payload!.ventasXProductoEmprenedorList!.length;
                      i++) {
                    for (var element in venta.prodVendidos.toList()) {
                      if (element.nombreProd ==
                              responseGetProductosVendidosParse
  ...
  Future<int> syncAddProductoVendido(
  ...
  Future<int> syncAddSingleProductoVendido(
      ProdVendidos prodVendido, Bitacora bitacora, String idUsuario) async {
            ...
            if (!prodVendido.postEmiWeb) {
              ...
              final responseAddProdVendido = await put(actualizarProdVendidoUri,
                  ...
                  body: jsonEncode({
                    ...
                    "fechaTermino": DateFormat("yyyy-MM-ddTHH:mm:ss")
                        .format(prodVendido.venta.target!.fechaTermino),
                        ...
                        if (prodVendido.nombreProd ==
                            ...
                            prodVendido.costo ==
                                responseGetProductosVendidosParse
                                    ...
                                    .productoEmprendedorDto!
                                    .costoUnidadMedida &&
                            prodVendido.cantVendida ==
                                responseGetProductosVendidosParse
                                    .payload!
                                    .ventasXProductoEmprenedorList![i]
                                    .productoEmprendedorDto!
                                    .cantidadVendida &&
                            prodVendido.precioVenta ==
                                responseGetProductosVendidosParse
                                    .payload!
                                    .ventasXProductoEmprenedorList![i]
                                    .productoEmprendedorDto!
                                    .precioVenta &&
                            prodVendido.unidadMedida.target!.unidadMedida ==
                                responseGetProductosVendidosParse
                                    .payload!
                                    .ventasXProductoEmprenedorList![i]
                                    .productoEmprendedorDto!
  ...
  Future<int> syncUpdateProductoVendido(
      ProdVendidos prodVendido, Bitacora bitacora, String idUsuario) async {
  ...
  Future<int> syncDeleteProductoVendido(
      Bitacora bitacora, String idUsuario) async {
            ...
            if (inversion.idEmiWeb == null) {
              ...
              switch (responsePostInversion.statusCode) {
                case 200:
                  ...
                  final responsePostInversionParse =
                      postSimpleRegistroExitosoEmiWebFromMap(const Utf8Decoder()
                          .convert(responsePostInversion.bodyBytes));
                  //Creamos los prod Solicitados
                  for (var i = 0;
                      i < inversion.prodSolicitados.toList().length;
                      i++) {
                    if (inversion.prodSolicitados
                            .toList()[i]
                            .imagen
                            .target
                            ?.path !=
                      ...
                      final crearImagenProdSolicitadoUri =
                          Uri.parse('$baseUrlEmiWebServices/documentos/crear');
                      final responsePostImagenProdSolicitado =
                          await post(crearImagenProdSolicitadoUri,
                              headers: headers,
                              body: jsonEncode({
                                "idCatTipoDocumento": "8", //Prod Solicitado
                                "nombreArchivo": inversion.prodSolicitados
                                    .toList()[i]
                                    .imagen
                                    .target!
                                    .nombre,
                                "archivo": inversion.prodSolicitados
                                    .toList()[i]
                                    .imagen
                                    .target!
                                    .base64,
                      ...
                      switch (responsePostImagenProdSolicitado.statusCode) {
                        case 200:
                          ...
                          final responsePostImagenProdSolicitadoParse =
                              postRegistroImagenExitosoEmiWebFromMap(
                                  const Utf8Decoder().convert(
                                      responsePostImagenProdSolicitado
                                          .bodyBytes));
                          print(
                              "Id de la Imagen: ${responsePostImagenProdSolicitadoParse.payload.idDocumento.toString()}");
                          inversion.prodSolicitados
                              ...
                              responsePostImagenProdSolicitadoParse
                                  .payload.idDocumento
                                  .toString();
                          dataBase.imagenesBox.put(inversion.prodSolicitados
                              .toList()[i]
                              .imagen
                              .target!);
                          print(
                              "Se recupera el idEmiWeb de la imagen prod solicitado");
                          final crearProdSolicitadosUri = Uri.parse(
                              '$baseUrlEmiWebServices/productosSolicitados');
                          final responsePostProdSolicitado =
                              await post(crearProdSolicitadosUri,
                                  headers: headers,
                                  body: jsonEncode({
                                    "idInversion":
                                        responsePostInversionParse.payload,
                                    "producto": inversion.prodSolicitados
                                        .toList()[i]
                                        .producto,
                                    "descripcion": inversion.prodSolicitados
                                        .toList()[i]
                                        .descripcion,
                                    "idCatTipoEmpaque": inversion
                                        .prodSolicitados
                                        .toList()[i]
                                        .tipoEmpaques
                                        .target!
                                    ...
                                    "marcaSugerida": inversion.prodSolicitados
                                        .toList()[i]
                                        .marcaSugerida,
                                    "proveedorSugerido": inversion
                                        .prodSolicitados
                                        .toList()[i]
                                        .proveedorSugerido,
                                    "costoEstimado": (inversion.prodSolicitados
                                            .toList()[i]
                                            .cantidad *
                                        (inversion.prodSolicitados
                                                .toList()[i]
                          ...
                          switch (responsePostProdSolicitado.statusCode) {
                            case 200:
                              ...
                              final responsePostProdSolicitadoParse =
                                  postRegistroExitosoEmiWebFromMap(
                                      const Utf8Decoder().convert(
                              ...
                              dataBase.productosSolicitadosBox
                                  .put(inversion.prodSolicitados.toList()[i]);
                              continue;
                            default:
                      ...
                      final crearProdSolicitadosUri = Uri.parse(
                          '$baseUrlEmiWebServices/productosSolicitados');
                      final responsePostProdSolicitado = await post(
                          crearProdSolicitadosUri,
                          headers: headers,
                          body: jsonEncode({
                            "idInversion": responsePostInversionParse.payload,
                            "producto":
                                inversion.prodSolicitados.toList()[i].producto,
                            "descripcion": inversion.prodSolicitados
                                .toList()[i]
                                .descripcion,
                            "idCatTipoEmpaque": inversion.prodSolicitados
                                .toList()[i]
                                .tipoEmpaques
                                .target!
                                .idEmiWeb,
                            ...
                            "marcaSugerida": inversion.prodSolicitados
                                .toList()[i]
                                .marcaSugerida,
                            "proveedorSugerido": inversion.prodSolicitados
                                .toList()[i]
                                .proveedorSugerido,
                            "costoEstimado": (inversion.prodSolicitados
                                    .toList()[i]
  ...
  Future<int> syncAddPagoInversion(
  ...
  Future<int> syncUpdateEmprendedor(
    ...
    if (idProyectoEmiWeb != null) {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            // Primero creamos el API para realizar la actualización
            final actualizarEmprendedorUri = Uri.parse(
                '$baseUrlEmiWebServices/emprendedores/registro/actualizar');
            final headers = ({
              "Content-Type": "application/json",
              'Authorization': 'Bearer $tokenGlobal',
            });
            final responseUpdateEmprendedor =
                await put(actualizarEmprendedorUri,
                    headers: headers,
                    body: jsonEncode({
  ...
  Future<int> syncUpdateEmprendimiento(Emprendimientos emprendimiento,
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateEmprendimiento =
                await put(actualizarEmprendimientoUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuarioRegistra":
  ...
  Future<int> syncUpdateFaseEmprendimiento(Emprendimientos emprendimiento,
      Bitacora bitacora, String idUsuario) async {
  ...
  Future<int> syncUpdateEstadoInversion(
      Inversiones inversion, Bitacora bitacora, String idUsuario) async {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            final estadoActual = dataBase.estadoInversionBox
                .query(EstadoInversion_.estado
                    .equals(bitacora.instruccionAdicional!))
                .build()
                .findUnique();
            if (estadoActual != null) {
              ...
              final responseUpdateEstasyncUpdateEstadoInversion =
                  await put(syncUpdateEstadoInversionUri,
                      headers: headers,
                      body: jsonEncode({
                        "idUsuarioRegistra": inversion
                            .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncUpdateImagenJornada2(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateImagenJornada2 =
                await put(actualizarImagenJornada2Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": imagen.tarea.target!.jornada.target!
                          .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncUpdateImagenJornada3(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateImagenJornada3 =
                await put(actualizarImagenJornada3Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": imagen.tarea.target!.jornada.target!
                          .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncUpdateProductoInversionJ3(ProdSolicitado prodSolicitado,
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateProductoProyecto =
  ...
  Future<int> syncUpdateImagenJornada4(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateImagenJornada4 =
                await put(actualizarImagenJornada4Uri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": imagen.tarea.target!.jornada.target!
                          .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncDeleteImagenJornada(
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseDeleteImagenJornada = await delete(
                eliminarImagenJornada,
                headers: headers,
                body: jsonEncode({}));
  ...
  Future<int> syncDeleteProductoInversionJ3(
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseDeleteProductoInversionJ3 =
                await put(eliminarProductoInversionJ3,
                    headers: headers,
                    body: jsonEncode({
                      {
  ...
  Future<int> syncUpdateTareaConsultoria(
              ...
              if (tarea.imagenes.first.idEmiWeb == null) {
                ...
                switch (responsePostImagenProductoEmp.statusCode) {
                  case 200:
                    ...
                    final responsePostConsultoria =
                        await post(actualizarTareaConsultoriaUri,
                            headers: headers,
                            body: jsonEncode({
                              "idUsuarioRegistra": tarea
                                  .consultoria
                                  .target!
                                  .emprendimiento
                                  .target!
  ...
  Future<int> syncUpdateProductoEmprendedor(ProductosEmp productoEmprendedor,
      Bitacora bitacora, String idUsuario) async {
    ...
    if (idProyectoEmiWeb != null) {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            // Primero creamos el API para realizar la actualización
            final actualizarProductoEmprendedorUri = Uri.parse(
                '$baseUrlEmiWebServices/productos/emprendedores/registro/actualizar');
            final headers = ({
              "Content-Type": "application/json",
              'Authorization': 'Bearer $tokenGlobal',
            });
            final responseUpdateEmprendedor =
                await put(actualizarProductoEmprendedorUri,
                    headers: headers,
                    body: jsonEncode({
  ...
  Future<int> syncUpdateImagenProductoEmprendedor(
      Imagenes imagen, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseUpdateImagenProductoEmprendedor =
                await put(actualizarImagenProdEmprendedorUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": imagen.productosEmp.target!.emprendimientos
                          .target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncUpdateProductosVendidosVenta(
      Ventas venta, Bitacora bitacora, String idUsuario) async {
  ...
  Future<int> syncAcceptProdCotizado(
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseAceptarProdCotizado =
                await put(aceptarProdCotizadoUri,
                    headers: headers,
                    body: jsonEncode({
                      "productos": [
                        {
  ...
  Future<int> syncAcceptInversionesXProductosCotizados(
          ...
          try {
            ...
            if (actualEstadoInversion != null) {
              ...
              switch (responseAceptarInversionXProdCotizados.statusCode) {
                case 200:
                  print(
                      "Caso 200 en Emi Web Aceptar Inversión x Prod cotizados");
                  // Creamos el API para realizar la actualización del estado de inversión
                  final actualizarEstadoInversionUri = Uri.parse(
                      '$baseUrlEmiWebServices/inversion/estadoInversion');
                  final headers = ({
                    "Content-Type": "application/json",
                    'Authorization': 'Bearer $tokenGlobal',
                  });
                  final responsePutEstadoInversion =
                  ...
                  switch (responsePutEstadoInversion.statusCode) {
                    case 200:
                      ...
                      final actualizarMontoSaldoTotalInversionUri = Uri.parse(
                          '$baseUrlEmiWebServices/inversiones/promotor/inversionRecibida');
                      final headers = ({
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer $tokenGlobal',
                      });
                      final responsePutMontoSaldoTotalInversion =
                          await put(actualizarMontoSaldoTotalInversionUri,
                              headers: headers,
                              body: jsonEncode({
                                "idUsuario": inversionXprodCotizados
                                    .inversion
                                    .target!
                                    .emprendimiento
                                    .target!
                      ...
                      switch (responsePutMontoSaldoTotalInversion.statusCode) {
                        case 200:
                          print(
                              "Caso 200 en Emi Web  Actualizar monto, saldo, total Inversión");
                          //Se marca como realizada en EmiWeb la instrucción en Bitacora
                          bitacora.executeEmiWeb = true;
                          dataBase.bitacoraBox.put(bitacora);
                          return 1;
                        default: //No se realizo con éxito el put
                          print(
                              "Error en actualizar monto, saldo y total inversion Emi Web");
                          return 0;
                      }
                    default: //No se realizo con éxito el put
                      print("Error en actualizar estado inversion Emi Web");
                ...
                default: //No se realizo con éxito el update
                  print(
                      "Error en aceptar Inversion por Prod cotizados Emi Web");
                  return 0;
              }
            } else {
  ...
  Future<bool> syncUpdateImagenUsuario(
    ...
    try {
      ...
      final responsePostUpdateImagenUsuario =
    ...
    try {
      ...
      switch (responsePostAddImagenUsuario.statusCode) {
        case 200:
          ...
          dataBase.imagenesBox.put(imagen);
          print(
              "ID DE IMAGEN NUEVO: ${responsePostImagenUsuarioParse.payload.idDocumento.toString()}");
          //Se marca como realizada en EmiWeb la instrucción en Bitacora
          bitacora.executeEmiWeb = true;
          dataBase.bitacoraBox.put(bitacora);
          return true;
  ...
  Future<int> syncArchivarEmprendimiento(Emprendimientos emprendimiento,
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseArchivarEmprendimiento =
                await put(archivarEmprendimientoUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuarioRegistra":
                          emprendimiento.usuario.target!.idEmiWeb,
  ...
  Future<int> syncDesarchivarEmprendimiento(Emprendimientos emprendimiento,
      Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseDesarchivarEmprendimiento =
                await put(desarchivarEmprendimientoUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuarioRegistra":
                          emprendimiento.usuario.target!.idEmiWeb,
  ...
  Future<int> syncArchivarConsultoria(
      Consultorias consultoria, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseArchivarConsultoria =
                await put(archivarConsultoriaUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": consultoria
                          .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncDesarchivarConsultoria(
      Consultorias consultoria, Bitacora bitacora, String idUsuario) async {
      ...
      if (responseGetUsuarioEstatusProyecto.statusCode == 200) {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            ...
            final responseDesarchivarConsultoria =
                await put(desarchivarConsultoriaUri,
                    headers: headers,
                    body: jsonEncode({
                      "idUsuario": consultoria
                          .emprendimiento.target!.usuario.target!.idEmiWeb,
  ...
  Future<int> syncAddImagenesEntregaInversion(
      Inversiones inversion, Bitacora bitacora, String idUsuario) async {
        ...
        if (responseProyecto.payload.idPromotor.toString() == idUsuario &&
          ...
          try {
            if (inversion.imagenFirmaRecibido.target!.idEmiWeb == null) {
              ...
              final responsePostImagenFirmaRecibido =
                  await post(crearImagenFirmaRecibidoUri,
                      headers: headers,
                      body: jsonEncode({
                ...
                case 200:
                  ...
                  inversion.imagenFirmaRecibido.target!.idEmiWeb =
                      responsePostImagenFirmaRecibidoParse.payload.idDocumento
                          .toString();
                  dataBase.imagenesBox
                      .put(inversion.imagenFirmaRecibido.target!);
                  ...
                  final responsePostImagenProductoEntregado =
                      await post(crearImagenProductoEntregadoUri,
                          headers: headers,
                          body: jsonEncode({
                            "idCatTipoDocumento": "11", //Producto entregado
                            "nombreArchivo": inversion
                                .imagenProductoEntregado.target!.nombre,
                            "archivo": inversion
                  ...
                  switch (responsePostImagenProductoEntregado.statusCode) {
                    case 200:
                      print("Caso 200 en Emi Web Imagen Frirma de recibo");
                      final responsePostImagenProductoEntregadoParse =
                          postRegistroImagenExitosoEmiWebFromMap(
                              const Utf8Decoder().convert(
                      ...
                      final actualizarImagenFirmaRecibidoUri = Uri.parse(
                          '$baseUrlEmiWebServices/inversiones/actualizar/documentos');
                      final headers = ({
                        "Content-Type": "application/json",
                        'Authorization': 'Bearer $tokenGlobal',
                      });
                      final responseActualizarImagenesFirmaRecibidoProductoEntregado =
                      ...
                      switch (
                          responseActualizarImagenesFirmaRecibidoProductoEntregado
                              .statusCode) {
                        case 200:
                          print(
                              "Caso 200 en Emi Web Actualizar Imagen Frirma de recibo y Producto Entregado");
                          //Se marca como realizada en EmiWeb la instrucción en Bitacora
                          bitacora.executeEmiWeb = true;
                          dataBase.bitacoraBox.put(bitacora);
                          return 1;
                        default:
                          ...
                          print(
                              "Error en Emi Web Imagen Firma de recibo y Producto Entregado");
                          return 0;
                      }
                    default: //No se realizo con éxito el post
                ...
                final responsePostImagenProductoEntregado =
                    await post(crearImagenProductoEntregadoUri,
                        ...
                        body: jsonEncode({
                          "idCatTipoDocumento": "11", //Producto entregado
                          "nombreArchivo":
                              inversion.imagenProductoEntregado.target!.nombre,
                          "archivo":
      ...
      if (await getTokenOAuth()) {
        ...
        switch (response.statusCode) {
          case 200: //Caso éxitoso
            ...
            print(
                "Tamaño: ${inversion.inversionXprodCotizados.toList().length}");
            final responseListProdCotizados = getProdCotizadosEmiWebFromMap(
                const Utf8Decoder().convert(response.bodyBytes));
            print(
                "Indice a buscar: ${int.parse(inversion.inversionXprodCotizados.toList()[inversion.inversionXprodCotizados.toList().length - 2].idEmiWeb!)}");
            print(
                "${responseListProdCotizados.payload![int.parse(inversion.inversionXprodCotizados.toList()[inversion.inversionXprodCotizados.toList().length - 2].idEmiWeb!)] != []}");
          ...
          if (estadoInversion.estado == "En Cotización") {
            ...
            if (await getTokenOAuth()) {
              ...
              switch (response.statusCode) {
                case 200: //Caso éxitoso
                  print(
                      "200 Con Caso éxitoso en get Productos Exitosos Emi Web");
                  final responseListProdCotizados =
                      getProdCotizadosEmiWebFromMap(
                          const Utf8Decoder().convert(response.bodyBytes));
                  //Se crea la instancia de inversion x prod Cotizados en el backend
                  print(
                      "SE CREA LA INSTANCIA DE INVERSION X PROD COTIZADOS EN BACKEND");
                  final inversionXprodCotizados =
                      inversion.inversionXprodCotizados.last;
                  print(
                      "ID EMI WEB: ${responseListProdCotizados.payload![responseListProdCotizados.payload!.length - 1].first.idListaCotizacion.toString()}");
                  ...
                  print(
                      "ID INVERSION FK: ${inversionXprodCotizados.inversion.target!.idDBR}");
                  final recordInversionXProdCotizados = await client.records
                      .create('inversion_x_prod_cotizados', body: {
                    "id_inversion_fk":
                        inversionXprodCotizados.inversion.target!.idDBR,
                    "id_emi_web": responseListProdCotizados
                        .payload![responseListProdCotizados.payload!.length - 1]
                        .first
                        .idListaCotizacion
                        .toString(),
                  });
                  if (recordInversionXProdCotizados.id.isNotEmpty) {
                    ...
                    for (var i = 0;
                        i <
                            responseListProdCotizados
                                .payload![
                                    responseListProdCotizados.payload!.length -
                                        1]
                                .first
                      ...
                      if (recordProdCotizado.isEmpty) {
                        final productoProveedor = dataBase.productosProvBox
                            .query(ProductosProv_.nombre
                                .equals(responseListProdCotizados
                                    .payload![responseListProdCotizados.payload!.length -
                                        1]
                                    .first
                                    .productosCotizadosList![i]
                                    .producto)
                                .and(ProductosProv_.marca.equals(responseListProdCotizados
                                    .payload![
                                        responseListProdCotizados.payload!.length -
                                            1]
                                    .first
                                    .productosCotizadosList![i]
                                    .marca))
                                .and(ProductosProv_.descripcion.equals(
                                    responseListProdCotizados
                                        .payload![responseListProdCotizados.payload!.length - 1]
                                        .first
                                        .productosCotizadosList![i]
                        ...
                        if (productoProveedor != null) {
                          await client.records
                            ...
                            "cantidad": responseListProdCotizados
                                .payload![
                                    responseListProdCotizados.payload!.length -
                                        1]
                                .first
                                .productosCotizadosList![i]
                                .cantidad,
                            "costo_total": responseListProdCotizados
                                .payload![
                                    responseListProdCotizados.payload!.length -
                                        1]
                                .first
                    ...
                    if (newEstadoInversion != null) {
                      final updateInversion = await client.records
