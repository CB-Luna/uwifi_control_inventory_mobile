...
//       final path = storagePath(currentUserId.toString(), media.name, false, index);
...
//     return null;
//   }
//   final path = storagePath(currentUserId.toString(), pickedMedia!.name, isVideo);
//   return [SelectedMedia(path, mediaBytes)];
// }
...
//     return null;
//   }
//   final path = storagePath(currentUserId.toString(), file.name, false);
