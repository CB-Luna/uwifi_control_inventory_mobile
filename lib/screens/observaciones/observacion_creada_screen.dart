...
class ObservacionCreadaScreen extends StatefulWidget {
  const ObservacionCreadaScreen({Key? key}) : super(key: key);

  @override
  State<ObservacionCreadaScreen> createState() => _ObservacionCreadaScreenState();
}

class _ObservacionCreadaScreenState extends State<ObservacionCreadaScreen> {
