...
class OrdenTrabajoNoCreadaScreen extends StatefulWidget {
  const OrdenTrabajoNoCreadaScreen({Key? key}) : super(key: key);

  @override
  State<OrdenTrabajoNoCreadaScreen> createState() => _OrdenTrabajoNoCreadaScreenState();
}

class _OrdenTrabajoNoCreadaScreenState extends State<OrdenTrabajoNoCreadaScreen> {
