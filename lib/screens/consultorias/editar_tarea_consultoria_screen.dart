...
class EditarTareaConsultoriaScreen extends StatefulWidget {
  ...
  @override
  _EditarTareaConsultoriaScreenState createState() =>
      _EditarTareaConsultoriaScreenState();
}

class _EditarTareaConsultoriaScreenState
    extends State<EditarTareaConsultoriaScreen> {
  ...
  void initState() {
    ...
    fechaRevisionText = TextEditingController(
        text: dateTimeFormat('yMMMd', widget.tarea.fechaRevision));
    tareaController = TextEditingController(text: widget.tarea.tarea);
    comentariosController =
        TextEditingController(text: widget.tarea.observacion);
                            ...
                            onPressed: () async {
                              if (consultoriaProvider.validateForm(formKey)) {
                                ...
                                if (tareaController.text !=
                                        widget.tarea.tarea ||
                                    fechaRevision !=
                                        widget.tarea.fechaRevision ||
                                    comentariosController.text !=
                                        widget.tarea.observacion ||
                                    descController.text !=
