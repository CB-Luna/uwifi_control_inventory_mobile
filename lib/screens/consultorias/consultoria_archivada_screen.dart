...
class ConsultoriaArchivadaScreen extends StatefulWidget {
  final int idEmprendimiento;
  const ConsultoriaArchivadaScreen({
    Key? key, 
    required this.idEmprendimiento, 
    }) : super(key: key);

  @override
  State<ConsultoriaArchivadaScreen> createState() => _ConsultoriaArchivadaScreenState();
}

class _ConsultoriaArchivadaScreenState extends State<ConsultoriaArchivadaScreen> {
