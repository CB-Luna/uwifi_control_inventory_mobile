...
class AgregarTareaConsultoriaScreen extends StatefulWidget {
  ...
  @override
  _AgregarTareaConsultoriaScreenState createState() =>
      _AgregarTareaConsultoriaScreenState();
}

class _AgregarTareaConsultoriaScreenState
    extends State<AgregarTareaConsultoriaScreen> {
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              if (consultoriaProvider.validateForm(formKey)) {
                                ...
                                consultoriaProvider
                                    .addTareaConsultoria(widget.consultoria.id);
