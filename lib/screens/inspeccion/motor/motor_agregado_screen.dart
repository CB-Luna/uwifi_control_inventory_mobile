...
class MotorAgregadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const MotorAgregadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<MotorAgregadoScreen> createState() => _MotorAgregadoScreenState();
}

class _MotorAgregadoScreenState extends State<MotorAgregadoScreen> {
