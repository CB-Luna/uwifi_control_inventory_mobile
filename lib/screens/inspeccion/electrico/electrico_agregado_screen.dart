...
class ElectricoAgregadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const ElectricoAgregadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<ElectricoAgregadoScreen> createState() => _ElectricoAgregadoScreenState();
}

class _ElectricoAgregadoScreenState extends State<ElectricoAgregadoScreen> {
