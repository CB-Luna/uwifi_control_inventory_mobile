...
import 'package:uwifi_control_inventory_mobile/screens/inventory/gateways/widgets/item_gateway_batch_temp.dart';
import 'package:uwifi_control_inventory_mobile/theme/theme.dart';
import 'package:uwifi_control_inventory_mobile/screens/widgets/flutter_flow_widgets.dart';

class GatewaysAdded extends StatelessWidget {
  
  GatewaysAdded({super.key});
                ...
                clipBehavior: Clip.antiAlias,
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      itemCount: batchGatewayProvider.gatewaysBatchTemp.length,
                      itemBuilder: (context, index) {
                        final gatewayBatchTemp = batchGatewayProvider.gatewaysBatchTemp[index];
                        return ItemGatewayBatchTemp(
                          gatewayBatchTemp: gatewayBatchTemp,
                          index: index + 1,
                        );
                      });
                    },
