...
class TrackingFormOCR extends StatelessWidget {
  
  const TrackingFormOCR({super.key});
                      ...
                      ScalableOCR(
                        ...
                        boxRightOff: 7,
                          ...
                          getScannedText: (value) async {
                            if (await orderFormProvider.autofillFieldsTrackingOCR(value)) {
                              orderMenuProvider.changeOptionOrdersDelivery(3);
                            }
                          }),
                      FFButtonWidget(
                        onPressed: () async {
