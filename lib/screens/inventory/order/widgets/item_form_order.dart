                          ...
                          SizedBox(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text(DateFormat("MMM-dd-yyyy").format(widget.order.orderCreation ?? DateTime.now())),
                              ],
                            )
                          ),
                          GestureDetector(
              ...
              onPressed: (context) async {
                await showDialog(
                  ...
                  builder: (alertDialogContext) {
                    return AlertDialog(
                      title: Text(
                          'Are you sure you want to delete the order with serial no. "${widget.order.orderId}"?'),
                      content: const Text(
                          'This action can not be undone.'),
                      actions: [
                        TextButton(
                          onPressed: () async {        
                            // if (await provider.deleteOrder(widget.bundle.routerDetailId, userProvider.usuarioCurrent!.sequentialId)) {
                              if(!mounted) return;
                            ...
                            //     content: Text(
                            //         "Falied to deleted with serial no. '${widget.order.orderId}'"),
                            //   ));
                            // }
                          },
                          child:
