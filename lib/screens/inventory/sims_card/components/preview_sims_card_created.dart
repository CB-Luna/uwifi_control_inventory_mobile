...
class PreviewSimsCardCreated extends StatefulWidget {
  
  const PreviewSimsCardCreated({super.key});

  @override
  State<PreviewSimsCardCreated> createState() => _PreviewSimsCardCreatedState();
}
class _PreviewSimsCardCreatedState extends State<PreviewSimsCardCreated> {
            ...
            Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      simsCardMenuProvider.changeOptionInventorySection(9);
                    },
                    text: 'Add',
                    icon: const Icon(
                      Icons.add_outlined,
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (batchSimCardProvider.simsCardBatch.isNotEmpty) {
                        if (await provider.addSimsCardBatchCreated(userProvider.usuarioCurrent)) {
                        ...
                        snackbarKey.currentState
                          ...
                          content: Text(
                              "Batch empty, please add at least one sim card to continue."),
                        ));
                      }
                    },
                    text: 'Upload',
