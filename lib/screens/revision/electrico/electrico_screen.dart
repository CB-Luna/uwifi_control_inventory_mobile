...
import 'package:taller_alex_app_asesor/screens/revision/electrico/components/seccion_dos_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/electrico/components/seccion_uno_formuario.dart';
import 'package:taller_alex_app_asesor/screens/revision/electrico/electrico_agregado_screen.dart';
import 'package:taller_alex_app_asesor/screens/ordenes_trabajo/detalle_orden_trabajo_screen.dart';

class ElectricoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const ElectricoScreen({
    super.key, 
    required this.ordenTrabajo
  });

  @override
  _ElectricoScreen createState() => _ElectricoScreen();
}

class _ElectricoScreen extends State<ElectricoScreen> {
                ...
                BottomNavigationBarItem(
                  icon: InkWell(
                    onTap: () async {
                      switch (activeStep) {
                        case 0:
                          if (electricoProvider.validarSeccionUnoFormulario()) {
                              setState(() {
                                activeStep++;
                              });
                            } else {
