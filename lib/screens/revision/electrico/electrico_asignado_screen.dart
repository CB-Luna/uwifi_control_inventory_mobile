...
class ElectricoAsignadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const ElectricoAsignadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<ElectricoAsignadoScreen> createState() => _ElectricoAsignadoScreenState();
}

class _ElectricoAsignadoScreenState extends State<ElectricoAsignadoScreen> {
