...
import 'package:taller_alex_app_asesor/screens/revision/electrico/electrico_asignado_screen.dart';
import 'package:taller_alex_app_asesor/screens/widgets/flutter_flow_expanded_image_view.dart';
import 'package:taller_alex_app_asesor/util/flutter_flow_util.dart';

class AsignacionElectricoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const AsignacionElectricoScreen({
    Key? key, 
    required this.ordenTrabajo,
  }) : super(key: key);

  @override
  _AsignacionElectricoScreenState createState() => _AsignacionElectricoScreenState();
}

class _AsignacionElectricoScreenState extends State<AsignacionElectricoScreen> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  electricoProvider.tecnicoMecanicoInterno?.path == null ?
                  Padding(
                      padding:
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              electricoProvider.tecnicoMecanicoInterno == null ?
                              "T M"
                              :
                              "${electricoProvider.tecnicoMecanicoInterno!.nombre.substring(0, 1)} ${
                                electricoProvider.tecnicoMecanicoInterno!.apellidoP.substring(0, 1)}",
                              style:
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.file(
                                  File(electricoProvider.tecnicoMecanicoInterno!.path!),
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: electricoProvider.tecnicoMecanicoInterno!.nombre,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            :
                            electricoProvider.tecnicoMecanicoInterno!.correo,
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      :
                      electricoProvider.tecnicoMecanicoInterno!.celular,
                      style: FlutterFlowTheme.of(context).bodyText1.override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                :
                                maybeHandleOverflow('${electricoProvider.tecnicoMecanicoInterno!.nombre} ${
                                  electricoProvider.tecnicoMecanicoInterno!.apellidoP} ${
                                  electricoProvider.tecnicoMecanicoInterno!.apellidoM}', 30, '...'),
                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily:
                                          FlutterFlowTheme.of(context).bodyText1Family,
                                      color: Colors.white,
                  ...
                  Padding(
                    ...
                    child: Autocomplete(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: SubstringHighlight(
                                  text: title,
                                  term: electricoProvider.tecnicoMecanicoCelularCorreoController.text,
                      ...
                      onSelected: (String selection) {
                        electricoProvider.seleccionarTecnicoMecanicoCelularCorreo(selection);
                      },
                      fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                        electricoProvider.tecnicoMecanicoCelularCorreoController = controller;
                        return TextFormField(
                          ...
                          onChanged: (value) {
                              electricoProvider.enCambioTecnicoMecanicoCelularCorreo(value);
                          },
                          obscureText: false,
                  ...
                  Visibility(
                    visible: electricoProvider.tecnicoMecanicoCelularCorreoSeleccionado == electricoProvider.tecnicoMecanicoCelularCorreoIngresado,
                    child: Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(16, 16, 16, 16),
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (electricoProvider.asignarTecnicoMecanicoInterno(widget.ordenTrabajo)) {
                            electricoProvider.limpiarInformacion();
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) =>
                                    ElectricoAsignadoScreen(
                                      ordenTrabajo: widget.ordenTrabajo,
                                    ),
                              ),
                            );
