...
class SuspensionDireccionNoAgregadaScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const SuspensionDireccionNoAgregadaScreen({
    Key? key, 
    required this.ordenTrabajo,
  }) : super(key: key);

  @override
  State<SuspensionDireccionNoAgregadaScreen> createState() => _SuspensionDireccionNoAgregadaScreenState();
}

class _SuspensionDireccionNoAgregadaScreenState extends State<SuspensionDireccionNoAgregadaScreen> {
