...
class SuspensionDireccionAsignadaScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const SuspensionDireccionAsignadaScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<SuspensionDireccionAsignadaScreen> createState() => _SuspensionDireccionAsignadaScreenState();
}

class _SuspensionDireccionAsignadaScreenState extends State<SuspensionDireccionAsignadaScreen> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(                                
                        'La asignación se ha guadado con éxito.',
                        textAlign: TextAlign.center,
                        style: FlutterFlowTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              color: Colors.black,
