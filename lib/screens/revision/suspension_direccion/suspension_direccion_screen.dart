...
import 'package:taller_alex_app_asesor/screens/revision/suspension_direccion/components/seccion_dos_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/suspension_direccion/components/seccion_tres_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/suspension_direccion/components/seccion_uno_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/suspension_direccion/suspension_direccion_agregada_screen.dart';
                ...
                BottomNavigationBarItem(
                  icon: InkWell(
                    onTap: () async {
                      switch (activeStep) {
                        case 0:
                          if (suspensionDireccionProvider.validarSeccionUnoFormulario()) {
                              setState(() {
                                activeStep++;
                              });
                            } else {
                          ...
                          break;
                        case 1:
                          if (suspensionDireccionProvider.validarSeccionDosFormulario()) {
                              setState(() {
                                activeStep++;
                              });
                            } else {
                          ...
                          if (suspensionDireccionProvider.validarSeccionTresFormulario()) {
                            if (suspensionDireccionProvider.agregarSuspensionDireccion(widget.ordenTrabajo, widget.ordenTrabajo.revision.target!.suspensionDireccion.target!)) {
                              ...
                              await Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder: (context) =>
                                      SuspensionDireccionAgregadaScreen(
                                        ordenTrabajo: widget.ordenTrabajo,
                                      ),
                                ),
                              );
