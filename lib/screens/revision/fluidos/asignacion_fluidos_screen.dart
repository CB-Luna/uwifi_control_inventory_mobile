...
class AsignacionFluidosScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const AsignacionFluidosScreen({
    Key? key, 
    required this.ordenTrabajo,
  }) : super(key: key);

  @override
  _AsignacionFluidosScreenState createState() => _AsignacionFluidosScreenState();
}

class _AsignacionFluidosScreenState extends State<AsignacionFluidosScreen> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  fluidosProvider.tecnicoMecanicoInterno?.path == null ?
                  Padding(
                      padding:
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              fluidosProvider.tecnicoMecanicoInterno == null ?
                              "T M"
                              :
                              "${fluidosProvider.tecnicoMecanicoInterno!.nombre.substring(0, 1)} ${
                                fluidosProvider.tecnicoMecanicoInterno!.apellidoP.substring(0, 1)}",
                              style:
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.file(
                                  File(fluidosProvider.tecnicoMecanicoInterno!.path!),
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: fluidosProvider.tecnicoMecanicoInterno!.nombre,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            :
                            fluidosProvider.tecnicoMecanicoInterno!.correo,
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      :
                      fluidosProvider.tecnicoMecanicoInterno!.celular,
                      style: FlutterFlowTheme.of(context).bodyText1.override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                :
                                maybeHandleOverflow('${fluidosProvider.tecnicoMecanicoInterno!.nombre} ${
                                  fluidosProvider.tecnicoMecanicoInterno!.apellidoP} ${
                                  fluidosProvider.tecnicoMecanicoInterno!.apellidoM}', 30, '...'),
                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily:
                                          FlutterFlowTheme.of(context).bodyText1Family,
                                      color: Colors.white,
                  ...
                  Padding(
                    ...
                    child: Autocomplete(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: SubstringHighlight(
                                  text: title,
                                  term: fluidosProvider.tecnicoMecanicoCelularCorreoController.text,
                      ...
                      onSelected: (String selection) {
                        fluidosProvider.seleccionarTecnicoMecanicoCelularCorreo(selection);
                      },
                      fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                        fluidosProvider.tecnicoMecanicoCelularCorreoController = controller;
                        return TextFormField(
                          ...
                          onChanged: (value) {
                              fluidosProvider.enCambioTecnicoMecanicoCelularCorreo(value);
                          },
                          obscureText: false,
                  ...
                  Visibility(
                    visible: fluidosProvider.tecnicoMecanicoCelularCorreoSeleccionado == fluidosProvider.tecnicoMecanicoCelularCorreoIngresado,
                    child: Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(16, 16, 16, 16),
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (fluidosProvider.asignarTecnicoMecanicoInterno(widget.ordenTrabajo)) {
                            fluidosProvider.limpiarInformacion();
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
