...
class FluidosAsignadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const FluidosAsignadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<FluidosAsignadoScreen> createState() => _FluidosAsignadoScreenState();
}

class _FluidosAsignadoScreenState extends State<FluidosAsignadoScreen> {
