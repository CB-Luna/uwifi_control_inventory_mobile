...
import 'package:taller_alex_app_asesor/screens/revision/fluidos/components/seccion_dos_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/fluidos/components/seccion_uno_formulario.dart';
import 'package:taller_alex_app_asesor/screens/revision/fluidos/fluidos_agregado_screen.dart';
import 'package:taller_alex_app_asesor/screens/ordenes_trabajo/detalle_orden_trabajo_screen.dart';

class FluidosScreen extends StatefulWidget {
  ...
  @override
  _FluidosScreen createState() => _FluidosScreen();
}

class _FluidosScreen extends State<FluidosScreen> {
                ...
                BottomNavigationBarItem(
                  icon: InkWell(
                    onTap: () async {
                      switch (activeStep) {
                        case 0:
                          if (fluidosProvider.validarSeccionUnoFormulario()) {
                              setState(() {
                                activeStep++;
                              });
                            } else {
