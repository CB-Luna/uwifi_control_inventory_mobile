...
class FluidosAgregadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const FluidosAgregadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<FluidosAgregadoScreen> createState() => _FluidosAgregadoScreenState();
}

class _FluidosAgregadoScreenState extends State<FluidosAgregadoScreen> {
