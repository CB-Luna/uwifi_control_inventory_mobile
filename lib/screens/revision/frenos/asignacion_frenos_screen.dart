...
import 'package:taller_alex_app_asesor/screens/revision/motor/motor_asignado_screen.dart';
import 'package:taller_alex_app_asesor/screens/widgets/flutter_flow_expanded_image_view.dart';
import 'package:taller_alex_app_asesor/util/flutter_flow_util.dart';

class AsignacionFrenosScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const AsignacionFrenosScreen({
    Key? key, 
    required this.ordenTrabajo,
  }) : super(key: key);

  @override
  _AsignacionFrenosScreenState createState() => _AsignacionFrenosScreenState();
}

class _AsignacionFrenosScreenState extends State<AsignacionFrenosScreen> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  frenosProvider.tecnicoMecanicoInterno?.path == null ?
                  Padding(
                      padding:
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              frenosProvider.tecnicoMecanicoInterno == null ?
                              "T M"
                              :
                              "${frenosProvider.tecnicoMecanicoInterno!.nombre.substring(0, 1)} ${
                                frenosProvider.tecnicoMecanicoInterno!.apellidoP.substring(0, 1)}",
                              style:
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.file(
                                  File(frenosProvider.tecnicoMecanicoInterno!.path!),
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: frenosProvider.tecnicoMecanicoInterno!.nombre,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            :
                            frenosProvider.tecnicoMecanicoInterno!.correo,
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      :
                      frenosProvider.tecnicoMecanicoInterno!.celular,
                      style: FlutterFlowTheme.of(context).bodyText1.override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                :
                                maybeHandleOverflow('${frenosProvider.tecnicoMecanicoInterno!.nombre} ${
                                  frenosProvider.tecnicoMecanicoInterno!.apellidoP} ${
                                  frenosProvider.tecnicoMecanicoInterno!.apellidoM}', 30, '...'),
                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily:
                                          FlutterFlowTheme.of(context).bodyText1Family,
                                      color: Colors.white,
                  ...
                  Padding(
                    ...
                    child: Autocomplete(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: SubstringHighlight(
                                  text: title,
                                  term: frenosProvider.tecnicoMecanicoCelularCorreoController.text,
                      ...
                      onSelected: (String selection) {
                        frenosProvider.seleccionarTecnicoMecanicoCelularCorreo(selection);
                      },
                      fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                        frenosProvider.tecnicoMecanicoCelularCorreoController = controller;
                        return TextFormField(
                          ...
                          onChanged: (value) {
                              frenosProvider.enCambioTecnicoMecanicoCelularCorreo(value);
                          },
                          obscureText: false,
                  ...
                  Visibility(
                    visible: frenosProvider.tecnicoMecanicoCelularCorreoSeleccionado == frenosProvider.tecnicoMecanicoCelularCorreoIngresado,
                    child: Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(16, 16, 16, 16),
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (frenosProvider.asignarTecnicoMecanicoInterno(widget.ordenTrabajo)) {
                            frenosProvider.limpiarInformacion();
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
