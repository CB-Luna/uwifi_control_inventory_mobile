...
class FrenosAsignadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const FrenosAsignadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<FrenosAsignadoScreen> createState() => _FrenosAsignadoScreenState();
}

class _FrenosAsignadoScreenState extends State<FrenosAsignadoScreen> {
