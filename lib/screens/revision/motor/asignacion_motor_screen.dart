...
class AsignacionMotorScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;
  const AsignacionMotorScreen({
    Key? key, 
    required this.ordenTrabajo,
  }) : super(key: key);

  @override
  _AsignacionMotorScreenState createState() => _AsignacionMotorScreenState();
}

class _AsignacionMotorScreenState extends State<AsignacionMotorScreen> {
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  motorProvider.tecnicoMecanicoInterno?.path == null ?
                  Padding(
                      padding:
                      ...
                      child: Container(
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Text(
                              motorProvider.tecnicoMecanicoInterno == null ?
                              "T M"
                              :
                              "${motorProvider.tecnicoMecanicoInterno!.nombre.substring(0, 1)} ${
                                motorProvider.tecnicoMecanicoInterno!.apellidoP.substring(0, 1)}",
                              style:
                          ...
                          await Navigator.push(
                            ...
                            PageTransition(
                              ...
                              child: FlutterFlowExpandedImageView(
                                image: Image.file(
                                  File(motorProvider.tecnicoMecanicoInterno!.path!),
                                  fit: BoxFit.contain,
                                ),
                                allowRotation: false,
                                tag: motorProvider.tecnicoMecanicoInterno!.nombre,
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            :
                            motorProvider.tecnicoMecanicoInterno!.correo,
                  ...
                  Padding(
                    ...
                    child: Text(
                      ...
                      :
                      motorProvider.tecnicoMecanicoInterno!.celular,
                      style: FlutterFlowTheme.of(context).bodyText1.override(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                :
                                maybeHandleOverflow('${motorProvider.tecnicoMecanicoInterno!.nombre} ${
                                  motorProvider.tecnicoMecanicoInterno!.apellidoP} ${
                                  motorProvider.tecnicoMecanicoInterno!.apellidoM}', 30, '...'),
                                style: FlutterFlowTheme.of(context).bodyText1.override(
                                      fontFamily:
                                          FlutterFlowTheme.of(context).bodyText1Family,
                                      color: Colors.white,
                  ...
                  Padding(
                    ...
                    child: Autocomplete(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return ListTile(
                                ...
                                title: SubstringHighlight(
                                  text: title,
                                  term: motorProvider.tecnicoMecanicoCelularCorreoController.text,
                      ...
                      onSelected: (String selection) {
                        motorProvider.seleccionarTecnicoMecanicoCelularCorreo(selection);
                      },
                      fieldViewBuilder: (context, controller, focusNode, onEditingComplete) {
                        motorProvider.tecnicoMecanicoCelularCorreoController = controller;
                        return TextFormField(
                          ...
                          onChanged: (value) {
                              motorProvider.enCambioTecnicoMecanicoCelularCorreo(value);
                          },
                          obscureText: false,
                  ...
                  Visibility(
                    visible: motorProvider.tecnicoMecanicoCelularCorreoSeleccionado == motorProvider.tecnicoMecanicoCelularCorreoIngresado,
                    child: Padding(
                      padding: const EdgeInsetsDirectional.fromSTEB(16, 16, 16, 16),
                      child: FFButtonWidget(
                        onPressed: () async {
                          if (motorProvider.asignarTecnicoMecanicoInterno(widget.ordenTrabajo)) {
                            motorProvider.limpiarInformacion();
                            await Navigator.push(
                              context,
                              MaterialPageRoute(
