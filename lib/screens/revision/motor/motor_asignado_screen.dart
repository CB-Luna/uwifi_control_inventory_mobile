...
class MotorAsignadoScreen extends StatefulWidget {
  final OrdenTrabajo ordenTrabajo;

  const MotorAsignadoScreen({
    Key? key, 
    required this.ordenTrabajo
  }) : super(key: key);

  @override
  State<MotorAsignadoScreen> createState() => _MotorAsignadoScreenState();
}

class _MotorAsignadoScreenState extends State<MotorAsignadoScreen> {
