...
class _EditarJornada4ScreenState extends State<EditarJornada4Screen> {
  ...
  void initState() {
    ...
    newConvenio = widget.jornada.tarea.target!.image.target?.imagenes ?? "NO FILE";
                                      ...
                                      child: InkWell(
                                          ...
                                          await Navigator.push(
                                            ...
                                            PageTransition(
                                              ...
                                              child:
                                                ...
                                                image: newConvenio == null ? Image.network(
                                        ...
                                        child: Hero(
                                          ...
                                          child: ClipRRect(
                                            ...
                                            child: newConvenio == null ?Image.network(
                                              'https://picsum.photos/seed/836/600',
                                              width: 170,
                                              height: 120,
                                              fit: BoxFit.cover,
                          ...
                          onPressed: () async {
                            if (jornadaProvider
                              ...
                              if (fechaRegistro != widget.jornada.fechaRegistro ||
                                    ...
                                    newConvenio != widget.jornada.tarea.target!.image.target?.imagenes ||
                                    activoController != widget.jornada.tarea.target!.activo 
                                    ) {
