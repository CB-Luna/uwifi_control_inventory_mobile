...
class EditarDetalleRegistroJornada extends StatefulWidget {
  final ProductosEmp productoEmp;

  const EditarDetalleRegistroJornada({
    Key? key, 
    required this.productoEmp,
    }) : super(key: key);
...
class _EditarDetalleRegistroJornadaState
  ...
  void initState() {
    ...
    familia = "";
    unidadMedida = "";
    productoController = TextEditingController(text: widget.productoEmp.nombre);
    descripcionController = TextEditingController(text: widget.productoEmp.descripcion);
    proveedorController = TextEditingController(text: widget.productoEmp.proveedor);
    costoController = TextEditingController(text: widget.productoEmp.costo.toString());
    cantidadController = TextEditingController(text: widget.productoEmp.cantidad.toString());
  }
