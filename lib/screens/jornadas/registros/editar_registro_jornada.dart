...
class EditarRegistroJornadaScreen extends StatefulWidget {
  ...
  const EditarRegistroJornadaScreen({
    Key? key, required this.inversion,
  }) : super(key: key);


  @override
  _EditarRegistroJornadaScreenState createState() => _EditarRegistroJornadaScreenState();
}

class _EditarRegistroJornadaScreenState extends State<EditarRegistroJornadaScreen>
  ...
  void initState() {
    ...
    for (var element in prodSolicitados) {
      totalProyecto += (element.costoEstimado == null ? 0  : element.costoEstimado! * element.cantidad); 
    }
  }
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      image: DecorationImage(
                                        fit: BoxFit.cover,
                                        image: Image.file(
                                          File(widget.inversion.emprendimiento.target!.imagen),
                                          fit: BoxFit.contain,
                                        ).image,
                                      ),
                                      boxShadow: const [
                                              ...
                                              Container(
                                                ...
                                                child:
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      Text(
                                                        widget.inversion.emprendimiento.target!.nombre,
                                                        style: AppTheme.of(context)
                                                            .bodyText1
                                                            .override(
                                                  ...
                                                  children: [
                                                    Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          prodSolicitados.length.toString(),
                                                          style: AppTheme.of(context).bodyText1.override(
                                                                fontFamily: AppTheme.of(context).bodyText1Family,
                                                                color: Colors.white,
                                                                fontSize: 25,
