...
import 'package:taller_alex_app_asesor/screens/widgets/pdf/api/pdf_invoice_consultorias.dart';
import 'package:taller_alex_app_asesor/screens/widgets/pdf/models/consultorias_invoice.dart';
...
import 'package:taller_alex_app_asesor/screens/widgets/pdf/api/pdf_invoice_emprendimiento.dart';
import 'package:taller_alex_app_asesor/screens/widgets/pdf/models/emprendimiento_invoice.dart';
import 'package:taller_alex_app_asesor/screens/widgets/pdf/api/pdf_invoice_jornadas.dart';
import 'package:taller_alex_app_asesor/screens/widgets/pdf/models/jornadas_invoice.dart';
import 'package:taller_alex_app_asesor/screens/widgets/pdf/models/invoice_info.dart';
import 'package:taller_alex_app_asesor/screens/widgets/custom_bottom_download_info.dart';
    ...
    return Query(
      ...
      builder: ((result, {fetchMore, refetch}) {
        if (result.isLoading) {
          ...
          print("***Result: ${jsonEncode(result.data)}");
          return WillPopScope(
