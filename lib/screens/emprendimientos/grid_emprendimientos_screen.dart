...
class GridEmpredimientosScreen extends StatefulWidget {
  const GridEmpredimientosScreen({Key? key}) : super(key: key);

  @override
  State<GridEmpredimientosScreen> createState() =>
      _GridEmpredimientosScreenState();
}

class _GridEmpredimientosScreenState extends State<GridEmpredimientosScreen> {
                            ...
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    10, 0, 10, 0),
                                child: Text(
                                  emprendimiento.comunidades.target?.nombre ??
                                      '',
                                  overflow: TextOverflow.ellipsis,
                                  maxLines: 2,
                                  style:
