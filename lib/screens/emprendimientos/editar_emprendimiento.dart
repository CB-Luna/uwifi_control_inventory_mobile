...
class _EditarEmprendimientoScreenState
  ...
  void initState() {
    ...
    nombreMunicipio =
        widget.emprendimiento.comunidad.target!.municipios.target!.nombre;
    nombreEstado = widget.emprendimiento.comunidad.target!.municipios.target!
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      if (newImagen !=
                                          ...
                                          nombreComunidad !=
                                              widget.emprendimiento.comunidad
                                                  .target!.nombre ||
                                          nombreMunicipio !=
                                              widget
                                                  .emprendimiento
