...
class EmprendimientoConsolidadoScreen extends StatefulWidget {
  const EmprendimientoConsolidadoScreen({
    Key? key, 
    }) : super(key: key);

  @override
  State<EmprendimientoConsolidadoScreen> createState() => _EmprendimientoConsolidadoScreenState();
}

class _EmprendimientoConsolidadoScreenState extends State<EmprendimientoConsolidadoScreen> {
