...
class DetalleProductoEmprendedor extends StatefulWidget {
  ...
  @override
  _DetalleProductoEmprendedorState createState() =>
      _DetalleProductoEmprendedorState();
}

class _DetalleProductoEmprendedorState
    extends State<DetalleProductoEmprendedor> {
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: widget.productoEmprendedor.emprendimientos
                                    .target!.imagen.target !=
                                null
                            ? FileImage(File(widget.productoEmprendedor
                                .emprendimientos.target!.imagen.target!.path!))
                            : Image.asset(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Text(
                                widget.productoEmprendedor.emprendimientos
                                    .target!.nombre,
                                maxLines: 1,
                                    ...
                                    Padding(
                                      padding:
                                          const EdgeInsetsDirectional.fromSTEB(
                                              0, 5, 0, 0),
                                      child: Text(
                                        widget.productoEmprendedor.unidadMedida
                                            .target!.unidadMedida,
                                        style: AppTheme.of(context)
                                            .bodyText1
                                            .override(
                                    ...
                                    Padding(
                                      padding:
                                          const EdgeInsetsDirectional.fromSTEB(
                                              0, 5, 0, 5),
                                      child: AutoSizeText(
                                        "${widget.productoEmprendedor.emprendimientos.target!.emprendedor.target!.nombre} ${widget.productoEmprendedor.emprendimientos.target!.emprendedor.target!.apellidos}",
                                        textAlign: TextAlign.start,
                                        maxLines: 1,
                                        style: AppTheme.of(context)
                                            .bodyText1
