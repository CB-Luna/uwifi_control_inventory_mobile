...
class EmprendimientoDesarchivadoScreen extends StatefulWidget {
  const EmprendimientoDesarchivadoScreen({
    Key? key, 
    }) : super(key: key);

  @override
  State<EmprendimientoDesarchivadoScreen> createState() => _EmprendimientoDesarchivadoScreenState();
}

class _EmprendimientoDesarchivadoScreenState extends State<EmprendimientoDesarchivadoScreen> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        "Listo, el emprendimiento\nregresará a la lista de emprendimientos.",
                        textAlign: TextAlign.center,
                        style: AppTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              color: Colors.black,
