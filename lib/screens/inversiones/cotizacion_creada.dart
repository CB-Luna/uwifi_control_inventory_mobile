...
class CotizacionCreada extends StatefulWidget {
  const CotizacionCreada({Key? key}) : super(key: key);

  @override
  State<CotizacionCreada> createState() => _CotizacionCreadaState();
}

class _CotizacionCreadaState extends State<CotizacionCreada> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Listo, la cotización se agregará \na la lista de partidas.',
                        textAlign: TextAlign.center,
                        style: AppTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              color: Colors.black,
