...
class EntregaInversionConcluida extends StatefulWidget {
  final int idEmprendimiento;

  const EntregaInversionConcluida({
    Key? key, 
    required this.idEmprendimiento
    }) : super(key: key);

  @override
  State<EntregaInversionConcluida> createState() =>
      _EntregaInversionConcluidaState();
}

class _EntregaInversionConcluidaState extends State<EntregaInversionConcluida> {
