...
class RecepcionInversionConcluida extends StatefulWidget {
  final int idEmprendimiento;

  const RecepcionInversionConcluida({
    Key? key, 
    required this.idEmprendimiento
    }) : super(key: key);

  @override
  State<RecepcionInversionConcluida> createState() =>
      _RecepcionInversionConcluidaState();
}

class _RecepcionInversionConcluidaState extends State<RecepcionInversionConcluida> {
