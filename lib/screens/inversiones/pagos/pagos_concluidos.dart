...
class PagosConcluidos extends StatefulWidget {
  final int idEmprendimiento;

  const PagosConcluidos({
    Key? key, 
    required this.idEmprendimiento
    }) : super(key: key);

  @override
  State<PagosConcluidos> createState() =>
      _PagosConcluidosState();
}

class _PagosConcluidosState extends State<PagosConcluidos> {
