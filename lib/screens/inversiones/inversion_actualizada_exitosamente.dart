...
class InversionActualizadaExitosamente extends StatefulWidget {
  final int idEmprendimiento;
  const InversionActualizadaExitosamente({Key? key, required this.idEmprendimiento}) : super(key: key);

  @override
  State<InversionActualizadaExitosamente> createState() => _InversionActualizadaExitosamenteState();
}

class _InversionActualizadaExitosamenteState extends State<InversionActualizadaExitosamente> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        'Listo, se actualizó con\n éxito el estado de la inversión.',
                        textAlign: TextAlign.center,
                        style: AppTheme.of(context).bodyText1.override(
                              fontFamily: 'Poppins',
                              color: Colors.black,
