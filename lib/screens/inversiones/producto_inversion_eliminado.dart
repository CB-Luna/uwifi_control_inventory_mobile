...
class ProductoInversionEliminado extends StatefulWidget {
  ...
  const ProductoInversionEliminado({
    Key? key, 
    required this.idEmprendimiento
    }) : super(key: key);

  @override
  State<ProductoInversionEliminado> createState() => _ProductoInversionEliminadoState();
}

class _ProductoInversionEliminadoState extends State<ProductoInversionEliminado> {
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          await Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  InversionesScreen(idEmprendimiento: 
