...
class CotizacionSimuladaExitosamente extends StatefulWidget {
  final int idEmprendimiento;
  const CotizacionSimuladaExitosamente({Key? key, required this.idEmprendimiento}) : super(key: key);

  @override
  State<CotizacionSimuladaExitosamente> createState() => _CotizacionSimuladaExitosamenteState();
}

class _CotizacionSimuladaExitosamenteState extends State<CotizacionSimuladaExitosamente> {
