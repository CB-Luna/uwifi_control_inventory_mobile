...
class EditarEmprendedorState extends State<EditarEmprendedor> {
  ...
  void initState() {
    ...
    nombreController =
        TextEditingController(text: widget.emprendedor.nombre);
    apellidosController =
        TextEditingController(text: widget.emprendedor.apellidos);
    curpController =
        TextEditingController(text: widget.emprendedor.curp);
    ...
    nombreComunidad = widget.emprendedor.comunidad.target?.nombre ?? "SIN COMUNIDAD";
    nombreMunicipio = widget.emprendedor.comunidad.target?.municipios.target?.nombre ?? " SIN MUNICIPIO";
    nombreEstado = widget.emprendedor.comunidad.target?.municipios.target?.estados.target?.nombre ?? "SIN ESTADO";
    listComunidades = [];
    listMunicipios = [];
    listEstados = [];
                                    ...
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Container(
                                          ...
                                          child: getImage(
                                            image?.path ?? widget.emprendedor.imagen
                                          ),
                                        ),
                                      ),
                                    ),
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  readOnly: true,
                                  enabled: false,
                                  initialValue: widget.emprendedor.emprendimiento.target!.nombre,
                                  obscureText: false,
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          if (newImagen != widget.emprendedor.imagen ||
                                              nombreController.text != widget.emprendedor.nombre || 
                                              apellidosController.text != widget.emprendedor.apellidos ||
                                              curpController.text != widget.emprendedor.curp ||
                                              integrantesController.text != widget.emprendedor.integrantesFamilia ||
                                              telefonoController.text != widget.emprendedor.telefono ||
                                              comentariosController.text != widget.emprendedor.comentarios ||
                                              nombreComunidad != widget.emprendedor.comunidad.target!.nombre ||
                                              nombreMunicipio != widget.emprendedor.comunidad.target!.municipios.target!.nombre ||
                                              nombreEstado != widget.emprendedor.comunidad.target!.municipios.target!.estados.target!.nombre) {
