...
class ClienteNoCreadoScreen extends StatefulWidget {
  const ClienteNoCreadoScreen({Key? key}) : super(key: key);

  @override
  State<ClienteNoCreadoScreen> createState() => _ClienteNoCreadoScreenState();
}

class _ClienteNoCreadoScreenState extends State<ClienteNoCreadoScreen> {
