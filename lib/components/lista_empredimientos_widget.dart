...
class ListaEmpredimientosWidget extends StatefulWidget {
  ...
  @override
  _ListaEmpredimientosWidgetState createState() =>
  ...
  Widget build(BuildContext context) {
        ...
        return SingleChildScrollView(
          child: Column(
            ...
            children:
                List.generate(emprendimientoProvider.emprendimientos.length, (columnIndex) {
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                maybeHandleOverflow(columnProyectosRecord.nombre, 30, "..."),
                                maxLines: 1,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text(
                                maybeHandleOverflow(columnProyectosRecord.descripcion, 30, "..."),
                                maxLines: 1,
                                style: AppTheme.of(context)
                                    .bodyText2
                                    .override(
