...
GetBasicJornadasEmiWeb getBasicJornadasEmiWebFromMap(String str) =>
    GetBasicJornadasEmiWeb.fromMap(json.decode(str));

String getBasicJornadasEmiWebToMap(GetBasicJornadasEmiWeb data) =>
...
class GetBasicJornadasEmiWeb {
  ...
  factory GetBasicJornadasEmiWeb.fromMap(Map<String, dynamic> json) =>
      GetBasicJornadasEmiWeb(
        status: json["status"],
        payload:
...
class Payload {
  ...
  factory Payload.fromMap(Map<String, dynamic> json) => Payload(
        jornada1: json["jornada1"] == null
            ? null
            : Jornada1.fromMap(json["jornada1"]),
        jornada2: json["jornada2"] == null
            ? null
            : Jornada2.fromMap(json["jornada2"]),
        jornada3: json["jornada3"] == null
            ? null
            : Jornada3.fromMap(json["jornada3"]),
        jornada4: json["jornada4"] == null
            ? null
            : Jornada4.fromMap(json["jornada4"]),
        productoDeProyecto: json["productoDeProyecto"] == null
            ? []
            : json["productoDeProyecto"] == null
                ? []
                : List<ProductoDeProyecto?>.from(json["productoDeProyecto"]!
                    .map((x) => ProductoDeProyecto.fromMap(x))),
      );
  ...
  Map<String, dynamic> toMap() => {
        ...
        "productoDeProyecto": productoDeProyecto == null
            ? []
            : productoDeProyecto == null
                ? []
                : List<dynamic>.from(
                    productoDeProyecto!.map((x) => x!.toMap())),
      };
}
